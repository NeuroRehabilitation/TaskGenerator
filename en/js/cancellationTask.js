function cancellationModel(elements, probability, size, numbers, order) {
  ...
  var exfunctions = (
    ...
    0.754 * T_numbersyes +
    Targets * 0.015 +
    Desorganizationyes * 0.683 +
    Distractors * T_lettersyes * 0.015
  ).toFixed(1);
...
function cancellationTask(
  ...
  if (numbers == 2) {
    var instructions =
      "Please cross out all the elements '      ' in the box below.";
    doc.addImage(targetImg, "JPEG", 113, 52, 6, 6);
  } else
    var instructions =
      "Please cross out all the elements ' " + target + " ' in the box below.";
