  ...
  return (function (e) {
    ...
    function (e, t, r) {
      ...
      t.create = function (e) {
        function t(e) {
          ...
          return (
            -1 === a
              ? ((i =
                  e.math === !0
                    ? e.factory(f.type, l, t, f.typed, f)
                    : e.factory(f.type, l, t, f.typed)),
                r.push(e),
                c.push(i))
              : (i = c[a]),
            i
        ...
        var r = [],
          ...
          f = o.mixin({});
        (f.type = {}),
          (f.expression = { transform: Object.create(f) }),
        ...
        (t.canDefineProperty = function () {
          try {
            if (Object.defineProperty)
              return (
                Object.defineProperty({}, "x", { get: function () {} }), !0
              );
          } catch (e) {}
          return !1;
        }),
        ...
        function e() {
          function t(e) {
            ...
            if (!t) {
              ...
              for (r = 0; r < N.types.length; r++)
                if (
                  ((n = N.types[r]), n.name.toLowerCase() == e.toLowerCase())
                ) {
                  i = n.name;
                  break;
                }
          ...
          function o(e, t) {
            ...
            for (var n = 0; n < r.length; n++) {
              var i = new a(r[n]);
              if (((this.params[n] = i), n === r.length - 1))
                this.varArgs = i.varArgs;
              else if (i.varArgs)
                throw new SyntaxError(
                  'Unexpected variable arguments operator "..."'
                );
            }
            this.fn = t;
          }
          ...
          function u(e) {
            ...
            for (
              ...
              if (((t = i[r]), t.varArgs))
                for (
                  var m = t.params.length - 1, h = t.params[m], v = 0;
                  v < h.types.length;
          ...
          function f(e, t) {
            ...
            for (r = 0; r < e.length; r++)
              (n = e[r]),
                n.params.length !== o || i || (i = n),
                void 0 != n.params[o] && u.push(n);
            u.sort(function (e, t) {
            ...
            for (r = 0; r < u.length; r++) {
              ...
              if (p) {
                if (p.param.varArgs)
                  throw new Error(
                    'Conflicting types "' + p.param + '" and "' + l + '"'
                  );
                p.signatures.push(n);
          ...
          (i.prototype.add = function (e, t) {
            ...
            return (
              -1 == n &&
                ((n = this.categories[r].length), this.categories[r].push(e)),
              r + n
            );
          }),
                ...
                if (n.length < r.params.length) {
                  ...
                  if (c.varArgs) {
                    for (s = c.clone(), i = 0; i < N.conversions.length; i++)
                      if (
                        ((u = N.conversions[i]),
                        !g(c.types, u.from) && g(c.types, u.to))
                      ) {
            ...
            (o.compare = function (e, t) {
              ...
              var r,
                ...
                o = 0;
              for (r = 0; n > r; r++)
                e.params[r].hasConversions() && i++,
                  t.params[r].hasConversions() && o++;
              if (i > o) return 1;
              if (o > i) return -1;
            ...
            (o.prototype.ignore = function () {
              for (var e = {}, t = 0; t < N.ignore.length; t++)
                e[N.ignore[t]] = !0;
            ...
            (o.prototype.toCode = function (e, t) {
              for (
                ...
                a.varArgs
                  ? (n[i] = "varArgs")
                  : o
                  ? (n[i] = e.add(o.convert, "convert") + "(arg" + i + ")")
                  : (n[i] = "arg" + i);
              }
            ...
            (s.prototype.toCode = function (e, r, n) {
              ...
              if (this.param) {
                var a = this.path.length - 1,
                  ...
                  s =
                    "// type: " +
                    (o ? o.from + " (convert to " + o.to + ")" : this.param);
                if (this.param.varArgs)
                  if (this.param.anyType)
                    i.push(r + "if (arguments.length > " + a + ") {"),
                    ...
                    i.push(r + "if (" + u(c, "arg" + a) + ") { " + s),
                      i.push(r + "  var varArgs = [arg" + a + "];"),
                      i.push(
                        r +
                          "  for (var i = " +
                          (a + 1) +
                    ...
                    for (var l = 0; l < c.length; l++) {
                      ...
                      if (p) {
                        ...
                        i.push(r + "    }"),
                          i.push(r + "    else if (" + m + "(arguments[i])) {"),
                          i.push(
                            r + "      varArgs.push(" + h + "(arguments[i]));"
                          );
                      }
                    }
                    i.push(r + "    } else {"),
            ...
            (s.prototype._innerCode = function (e, t, r) {
              ...
              this.signature &&
                (i.push(
                  t + "if (arguments.length === " + this.path.length + ") {"
                ),
              ...
              for (n = 0; n < this.childs.length; n++)
                i.push(this.childs[n].toCode(e, t, a));
      ...
      (t.isNumber = function (e) {
        ...
        (t.nearlyEqual = function (e, r, n) {
          ...
          if (isFinite(e) && isFinite(r)) {
            var i = Math.abs(e - r);
            return i < t.DBL_EPSILON
              ? !0
              : i <= Math.max(Math.abs(e), Math.abs(r)) * n;
          }
          return !1;
        });
    },
    function (e, t) {
      ...
      (r.prototype.toFixed = function (e) {
        var t = this.roundDigits(this.exponent + 1 + (e || 0)),
          ...
          a = i + (e || 0);
        return (
          r.length < a && (r = r.concat(n(a - r.length))),
        ...
        (r.prototype.toPrecision = function (e, t) {
          ...
          s.length < e && (s = s.concat(n(e - s.length))),
            (s = s.concat(
              n(u - s.length + 1 + (s.length < e ? e - s.length : 0))
            )),
            (s = n(-u).concat(s));
          var c = u > 0 ? u : 0;
          return (
            c < s.length - 1 && s.splice(c + 1, 0, "."), this.sign + s.join("")
          );
        }),
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n, c) {
        ...
        function l(e, t, r) {
          if ((r.wrap && "function" == typeof t && (t = m(t)), v(c[e]) && v(t)))
            return (
              (t = r.override
                ? n(s({}, c[e].signatures, t.signatures))
                : n(c[e], t)),
              (c[e] = t),
              p(e, t),
              void c.emit("import", e, function () {
                return t;
              })
            );
          if (void 0 === c[e] || r.override)
            return (
              (c[e] = t),
              p(e, t),
              void c.emit("import", e, function () {
        ...
        function p(e, t) {
          t &&
            ...
            (c.expression.transform[e] = t.transform);
        }
        function m(e) {
          var t = function () {
        ...
        function h(e, t) {
          if ("string" == typeof e.name) {
            var a = e.name,
              u = e.path ? o(c, e.path) : c,
              f = u.hasOwnProperty(a) ? u[a] : void 0,
              l = function () {
                var i = r(e);
                if (v(f) && v(i))
                  return (i = t.override
                    ? n(s({}, f.signatures, i.signatures))
                    : n(f, i));
                if (void 0 === f || t.override) return i;
                if (!t.silent)
                  throw new Error('Cannot import "' + a + '": already exists');
              };
            e.lazy !== !1 ? i(u, a, l) : (u[a] = l()),
              c.emit("import", a, l, e.path);
          } else r(e);
        }
        function g(e) {
          return (
    ...
    function (e, t, r) {
      e.exports = [r(244), r(281), r(283), r(14), r(489), r(491)];
    },
    function (e, t, r) {
      e.exports = [
        r(61),
          ...
          p = f("concat", {
            "...Array | Matrix | number | BigNumber": function (e) {
              ...
              for (t = 0; n > t; t++) {
                ...
                if (
                  (h && h.isMatrix === !0 && (p = !0),
                  "number" == typeof h || (h && h.isBigNumber === !0))
                ) {
                  if (t !== n - 1)
                    throw new Error(
                      "Dimension must be specified as last argument"
                    );
                  if (((r = f), (f = h.valueOf()), !o(f)))
                    throw new TypeError(
                  ...
                  var g = a(h).valueOf(),
                    v = s.size(g);
                  if (
                    ((m[t] = g), (r = f), (f = v.length - 1), t > 0 && f != r)
                  )
                    throw new c(r + 1, f + 1);
                }
              }
      ...
      (t.format = function (e, r) {
        ...
        switch (
          ...
          case "auto":
            ...
            r &&
              r.exponential &&
              (void 0 !== r.exponential.lower && (a = r.exponential.lower),
              void 0 !== r.exponential.upper && (o = r.exponential.upper));
            ({
            ...
            return (
              (s =
                u.gte(a) && u.lt(o)
                  ? e.toSignificantDigits(i).toFixed()
                  : t.toExponential(e, i)),
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        ...
        return (
          (v.toTex =
            "\\left(${args[0]}" + o.operators.subtract + "${args[1]}\\right)"),
          v
        );
      }
      var i = r(22);
    ...
    function (e, t) {
      ...
      t.toSymbol = function (e, n) {
        ...
        if (-1 !== e.indexOf("_")) {
          var i = e.indexOf("_");
          return (
            t.toSymbol(e.substring(0, i)) +
            "_{" +
            t.toSymbol(e.substring(i + 1)) +
            "}"
          );
        }
        return e;
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        ...
        return (
          (s.toTex = o.operators.unaryMinus + "\\left(${args[0]}\\right)"), s
        );
      }
      var i = r(29);
        ...
        var a = e.DenseMatrix,
          o = function (e, t, r, o) {
            ...
            var N = [],
              E = [];
            for (v = 0; y > v; v++) {
              for (var M = v + 1, A = p[v], _ = p[v + 1], O = A; _ > O; O++)
                (g = l[O]),
                  (N[g] = o ? b(f[O], s[g][v]) : b(s[g][v], f[O])),
                  (E[g] = M);
              for (g = 0; d > g; g++)
                E[g] === M ? (w[g][v] = N[g]) : (w[g][v] = s[g][v]);
            }
      ...
      function n(e, t, r, n) {
        var a = e.DenseMatrix,
          o = function (e, t, r, o) {
            ...
            "string" == typeof c &&
              c === h &&
              ((g = c), (y = n.convert(0, g)), (x = n.find(r, [g, g])));
        ...
        var o = n(r(33)),
          ...
          u = function (e, t, r) {
            ...
            for (M = 0; x > M; M++) {
              C[M] = T.length;
              var R = M + 1;
              for (A = c[M], _ = c[M + 1]; _ > A; A++)
                (E = u[A]), T.push(E), (k[E] = R), z && (z[E] = n[A]);
              for (A = h[M], _ = h[M + 1]; _ > A; A++)
                (E = m[A]),
                  k[E] !== R && T.push(E),
                  (I[E] = R),
                  B && (B[E] = p[A]);
      ...
      function n(e, t, r, n) {
        var a = n("equalScalar", {
          ...
          "Complex, Complex": function (e, r) {
            return (
              (e.re === r.re || i(e.re, r.re, t.epsilon)) &&
              (e.im === r.im || i(e.im, r.im, t.epsilon))
            );
          },
        ...
        var i = e.DenseMatrix,
          a = function (e, t, r, a) {
            ...
            var l,
              ...
              h = r;
            "string" == typeof f &&
              ((l = f), (t = n.convert(t, l)), (h = n.find(r, [l, l])));
            for (
              var g = [],
                v = new i({ data: g, size: [p, m], datatype: l }),
                d = [],
                y = [],
                x = 0;
              m > x;
      ...
      function n(e, t, r, n) {
        var i = e.DenseMatrix,
          o = function (e, t, r) {
            ...
            "string" == typeof c &&
              c === p &&
              ((g = c), (t = n.convert(t, g)), (v = n.find(r, [g, g])));
        ...
        var a = e.DenseMatrix,
          o = function (e, t, r, o) {
            var u,
              ...
              p = r;
            "string" == typeof l &&
              ((u = l), (t = n.convert(t, u)), (p = n.find(r, [u, u])));
        ...
        var s = r(26),
          ...
          y = function (e, t, r) {
            ...
            a &&
              ...
              a === u &&
              "string" == typeof a &&
              ((n = a), (l = o.find(c, [n, n])), (p = o.find(f, [n, n])));
            for (var m = p(i[0], s[0]), h = 1; r > h; h++)
              m = l(m, p(i[h], s[h]));
            return m;
          },
          x = function (e, t) {
          ...
          b = function (e, t) {
            ...
            a &&
              ...
              a === l &&
              "string" == typeof a &&
              ((r = a), (g = o.find(c, [r, r])), (v = o.find(f, [r, r])));
            for (var d = [], y = 0; m > y; y++) {
              for (var x = v(n[0], s[0][y]), b = 1; p > b; b++)
                x = g(x, v(n[b], s[b][y]));
              d[y] = x;
            }
          ...
          E = function (e, t) {
            ...
            a &&
              ...
              a === u &&
              "string" == typeof a &&
              ((r = a), (m = o.find(c, [r, r])), (g = o.find(f, [r, r])));
            for (var v = [], d = 0; l > d; d++) {
              for (var y = n[d], x = g(y[0], s[0]), b = 1; p > b; b++)
                x = m(x, g(y[b], s[b]));
              v[d] = x;
            }
          ...
          M = function (e, t) {
            ...
            a &&
              ...
              a === l &&
              "string" == typeof a &&
              ((r = a), (v = o.find(c, [r, r])), (d = o.find(f, [r, r])));
            for (var y = [], x = 0; p > x; x++) {
              var b = n[x];
              y[x] = [];
              for (var w = 0; g > w; w++) {
                for (var N = d(b[0], s[0][w]), E = 1; m > E; E++)
                  N = v(N, d(b[E], s[E][w]));
                y[x][w] = N;
              }
            }
            return 1 === p && 1 === g
              ? y[0][0]
              : new h({ data: y, size: [p, g], datatype: r });
          },
          A = function (e, t) {
            var r = e._data,
              n = e._size,
              ...
              for (var T = O + 1, C = 0; h > C; C++) {
                ...
                if (!x(S, b))
                  for (var z = i[C], B = i[C + 1], k = z; B > k; k++) {
                    var I = n[k];
                    _[I] !== T
                      ? ((_[I] = T), N.push(I), (A[I] = y(S, r[k])))
                      : (A[I] = d(A[I], y(S, r[k])));
                  }
              }
              for (var R = E[O], U = N.length, q = R; U > q; q++) {
                var P = N[q];
                w[q] = A[P];
              }
            }
          ...
          T = function (e, t) {
            ...
            s &&
              ...
              s === m &&
              "string" == typeof s &&
              ((r = s), (y = o.find(c, [r, r])), (x = o.find(f, [r, r])));
            for (
              var b,
                w,
                N,
              ...
              for (M = p[I], A = p[I + 1], E = M; A > E; E++)
                if (((O = l[E]), d))
                  for (w = a[O], N = a[O + 1], b = w; N > b; b++)
                    (_ = i[b]),
                      k[_] !== R
                        ? ((k[_] = R), C.push(_), (B[_] = x(u[E], n[b])))
                        : (B[_] = y(B[_], x(u[E], n[b])));
                else
                  for (w = a[O], N = a[O + 1], b = w; N > b; b++)
                    (_ = i[b]), k[_] !== R && ((k[_] = R), C.push(_));
              if (d)
                for (var U = S[I], q = C.length, P = U; q > P; P++) {
                  var L = C[P];
                  T[P] = B[L];
                }
            }
            return (
              (S[v] = C.length),
              1 === h && 1 === v && d ? (1 === T.length ? T[0] : 0) : z
            );
          };
        return (
          (v.toTex =
            "\\left(${args[0]}" + s.operators.multiply + "${args[1]}\\right)"),
          v
        );
      }
      var i = r(5).extend,
      ...
      function r(e, t, r, n) {
        var i = n("multiplyScalar", {
          ...
          "number, Unit": function (e, t) {
            var r = t.clone();
            return (
              (r.value = null === r.value ? r._normalize(e) : r.value * e), r
            );
          },
          "Unit, number": function (e, t) {
            var r = e.clone();
            return (
              (r.value = null === r.value ? r._normalize(t) : r.value * t), r
            );
          },
          "Unit, Unit": function (e, t) {
            return e.multiply(t);
          ...
          for (
            var n = function (e) {
                ...
                for (t = 0; t < e.length; t++) {
                  for (
                    n[t] = new Array(e.length), n[t][t] = p(i), r = 0;
                    t > r;
                    r++
                  )
                    n[t][r] = 0;
            ...
            "Array | Matrix": function (e) {
              ...
              switch (
                ...
                case 1:
                  ...
                  throw new RangeError(
                    "Matrix must be square (size: " + o.format(t) + ")"
                  );
                case 2:
                  var r = t[0],
                    n = t[1];
                ...
                default:
                  throw new RangeError(
                    "Matrix must be two dimensional (size: " + o.format(t) + ")"
                  );
              }
            },
          });
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        ...
        return (
          (h.toTex =
            "\\left(${args[0]}" + u.operators.add + "${args[1]}\\right)"),
          h
        );
      }
      var i = r(5).extend;
          ...
          u = function (e, t, r) {
            ...
            for (M = 0; x > M; M++) {
              ...
              for (_ = c[M], O = c[M + 1], A = _; O > A; A++)
                (E = u[A]), C.push(E), (I[E] = U), B && (B[E] = n[A]);
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, s) {
        ...
        function f(e, t, r, n, i, o) {
          ...
          for (var u = Math.min(n[0] - i, n[1] - o), c = [], f = 0; u > f; f++)
            c[f] = a(e[f + i][f + o]);
          return null !== r ? l(c) : c;
        }
        var l = n(r(23)),
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        function o(e, t) {
          ...
          if (r[0] != n[0])
            throw new RangeError(
              "Vectors must have equal length (" + r[0] + " != " + n[0] + ")"
            );
          if (0 == a)
            throw new RangeError(
      ...
      function n(e, t, n, o) {
        ...
        function u(t, r, n) {
          ...
          if (
            ...
            throw new Error(
              "Parameters in function eye must be positive integers"
            );
          if (!a(r) || 1 > r)
            throw new Error(
              "Parameters in function eye must be positive integers"
          ...
          for (var l = i.resize([], c, u), p = r > t ? t : r, m = 0; p > m; m++)
            l[m][m] = s;
          return l;
        }
        var c = n(r(23)),
                ...
                case 1:
                  if (1 == t[0])
                    return e.isMatrix === !0
                      ...
                      : [u(1, e[0])];
                  throw new RangeError(
                    "Matrix must be square (size: " + i.string.format(t) + ")"
                  );
                case 2:
                  var r = t[0],
                    n = t[1];
    ...
    function (e, t) {
      ...
      function r(e, t, r, n) {
        function i(t, r) {
          ...
          return 0 != n
            ? new e.Complex(
                (t.re * r.re + t.im * r.im) / n,
                (t.im * r.re - t.re * r.im) / n
              )
            : new e.Complex(0 != t.re ? t.re / 0 : 0, 0 != t.im ? t.im / 0 : 0);
        }
        var a = n("divide", {
          "number, number": function (e, t) {
            return e / t;
          ...
          "Unit, number": function (e, t) {
            var r = e.clone();
            return (
              (r.value = (null === r.value ? r._normalize(1) : r.value) / t), r
            );
          },
          "number, Unit": function (e, t) {
            var r = t.pow(-1);
            return (
              (r.value = (null === r.value ? r._normalize(1) : r.value) * e), r
            );
          },
          "Unit, Unit": function (e, t) {
            return e.divide(t);
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        function o(r, n) {
          ...
          return "bignumber" === t.number
            ? ((o = n ? f : c),
              a(
                o(
                  new e.BigNumber(i.start),
                  new e.BigNumber(i.end),
                  new e.BigNumber(i.step)
                )
              ))
        ...
        function c(e, t, r) {
          var n = [],
            i = e;
          if (r.gt(m)) for (; i.lt(t); ) n.push(i), (i = i.plus(r));
          else if (r.lt(m)) for (; i.gt(t); ) n.push(i), (i = i.plus(r));
          return n;
        }
        function f(e, t, r) {
          var n = [],
            i = e;
          if (r.gt(m)) for (; i.lte(t); ) n.push(i), (i = i.plus(r));
          else if (r.lt(m)) for (; i.gte(t); ) n.push(i), (i = i.plus(r));
          return n;
        }
        function l(e) {
          var t = e.split(":"),
          ...
          f = function (e) {
            ...
            switch (t.length) {
              case 1:
                ...
                throw new RangeError(
                  "Matrix must be square (size: " + a(t) + ")"
                );
              case 2:
                var n = t[0],
                  o = t[1];
              ...
              default:
                throw new RangeError(
                  "Matrix must be two dimensional (size: " + a(t) + ")"
                );
            }
          },
          l = function (e) {
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        return (
          (l.toTex = "\\left(${args[0]}\\right)" + s.operators.transpose), l
        );
      }
      var i = r(5).clone,
        a = r(20).format;
        ...
        var o = n(r(23)),
          ...
          x = function (e) {
            ...
            for (r = 0; o > r; r++) {
              ...
              if (
                (r !== M &&
                  ((w[r] = [w[M], (w[M] = w[r])][0]), v._swapRows(r, M, g)),
                i > r)
              )
                for (t = r + 1; i > t; t++) {
                  var C = g[t][r];
            ...
            for (r = 0; o > r; r++)
              for (t = 0; i > t; t++)
                0 === r && (o > t && (x[t] = []), (d[t] = [])),
                  r > t
                    ? (o > t && (x[t][r] = g[t][r]), i > r && (d[t][r] = 0))
                    : t !== r
                    ? (o > t && (x[t][r] = 0), i > r && (d[t][r] = g[t][r]))
                    : (o > t && (x[t][r] = g[t][r]), i > r && (d[t][r] = 1));
            var S = new v({ data: d, size: y }),
              z = new v({ data: x, size: b }),
              B = [];
          ...
          b = function (e) {
            ...
            for (r = 0; a > r; r++) {
              var C = new d();
              i > r && (b.push(y.length), y.push(1), x.push(r)),
                M.push(N.length);
              var S = v[r],
                z = v[r + 1];
              ...
              C.forEach(r + 1, i - 1, function (e, t) {
                ...
                r !== B &&
                  (g._swapRows(r, B, w[1], y, x, b),
                  g._swapRows(r, B, A[1], N, E, M),
                  C.swap(r, B),
                  T(r, B)),
                C.forEach(0, i - 1, function (e, t) {
                  r >= e
                    ? (N.push(t), E.push(e))
                    : ((t = c(t, k)), m(t, 0) || (y.push(t), x.push(e)));
                });
            }
            return (
              M.push(N.length),
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        var a = n("abs", {
          ...
          Unit: function (e) {
            var t = e.clone();
            return (t.value = Math.abs(t.value)), t;
          },
        });
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        ...
        return (
          (m.toTex =
            "\\left(${args[0]}" + p.operators.larger + "${args[1]}\\right)"),
          m
        );
      }
      var i = r(8).nearlyEqual;
      ...
      function n(e, t, r, n) {
        var a = e.DenseMatrix,
          o = function (e, t, r) {
            ...
            "string" == typeof u &&
              u === f &&
              ((l = u), (h = n.convert(0, l)), (g = n.find(r, [l, l])));
            var v,
              d,
              y = [];
            for (v = 0; p > v; v++) y[v] = [];
            var x = new a({ data: y, size: [p, m], datatype: l }),
              b = [],
              w = [],
              N = [],
              E = [];
        ...
        var i = n(r(69)),
          ...
          c = function (e, t, r) {
            ...
            if (r) {
              ...
              var g = s(m.parent, p);
              if (
                ((m.cp = u(h, m.parent, g, 1)),
                h && m.parent && m.cp && f(h, m))
              )
          ...
          f = function (e, t) {
            ...
            for (
              var v,
                ...
                G = 7 * (s + 1),
                H = R,
                Z = p(s, k, U, q, F, H, L, G, P, j, $, D),
                W = m(s, k, U, D, $, j, c, P, F, H, L),
                V = 0;
              s > W;

            ) {
              for (y = -1; s > V && -1 == (y = U[F + V]); V++);
              -1 != U[L + y] && (H[U[L + y]] = -1), (U[F + V] = U[L + y]);
              var Y = U[$ + y],
                J = U[P + y];
              W += J;
              var X = 0;
              ...
              for (
                ...
                if (((v = B[A]), !((_ = U[$ + v]) <= 0))) {
                  M = -U[P + v];
                  var te = Z - M;
                  for (Q = k[v], O = k[v] + _ - 1; O >= Q; Q++)
                    (w = B[Q]),
                      U[j + w] >= Z
                        ? (U[j + w] -= M)
                        : 0 !== U[j + w] && (U[j + w] = U[D + w] + te);
                }
              for (A = K; ee > A; A++) {
                for (
                  v = B[A],
              ...
              for (
                U[D + y] = X, u = Math.max(u, X), Z = h(Z + u, u, j, s), A = K;
                ee > A;
                A++
              )
                if (((v = B[A]), !(U[P + v] >= 0)))
                  for (
                    S = H[v], v = U[G + S], U[G + S] = -1;
                    -1 != v && -1 != U[L + v];
                    v = U[L + v], Z++
                  ) {
                    for (
                      E = U[q + v], _ = U[$ + v], Q = k[v] + 1;
                      Q <= k[v] + E - 1;
                      Q++
                    )
                      U[j + B[Q]] = Z;
                    var oe = v;
                    for (d = U[L + v]; -1 != d; ) {
                      var se = U[q + d] === E && U[$ + d] === _;
                      for (Q = k[d] + 1; se && Q <= k[d] + E - 1; Q++)
                        U[j + B[Q]] != Z && (se = 0);
                      se
                        ? ((k[d] = i(v)),
                          (U[P + v] += U[P + d]),
              ...
              for (Q = K, A = K; ee > A; A++)
                (v = B[A]),
                  (M = -U[P + v]) <= 0 ||
                    ...
                    (B[Q++] = v));
              (U[P + y] = J),
                0 === (U[q + y] = Q - K) && ((k[y] = -1), (U[j + y] = 0)),
                0 !== Y && (I = Q);
            }
            for (v = 0; s > v; v++) k[v] = i(k[v]);
            for (d = 0; s >= d; d++) U[F + d] = -1;
            for (d = s; d >= 0; d--)
              U[P + d] > 0 || ((U[L + d] = U[F + k[d]]), (U[F + k[d]] = d));
            for (w = s; w >= 0; w--)
              U[P + w] <= 0 ||
                (-1 != k[w] && ((U[L + w] = U[F + k[w]]), (U[F + k[w]] = w)));
            for (y = 0, v = 0; s >= v; v++)
              -1 == k[v] && (y = o(v, y, U, F, L, R, j));
          ...
          m = function (e, t, r, n, a, o, s, u, c, f, l) {
            for (var p = 0, m = 0; e > m; m++) {
              ...
              if (0 === h) (r[a + m] = -2), p++, (t[m] = -1), (r[o + m] = 0);
                ...
                (r[u + m] = 0), (r[a + m] = -1), p++, (t[m] = i(e)), r[u + e]++;
              else {
                var g = r[c + h];
        ...
        var t = e.SparseMatrix,
          r = function (e, r, n, i) {
            for (
              ...
              h[v] = g;
              for (
                var d = n ? n[v] : v, y = s[d], x = s[d + 1], b = y;
                x > b;
                b++
              ) {
                var w = r ? r[o[b]] : o[b];
            ...
            return (
              (h[l] = g),
              new t({ values: p, index: m, ptr: h, size: [f, l], datatype: c })
            );
          };
        return r;
      }
        ...
        var e = function (e, t) {
          ...
          for (var m = 0; u > m; m++) {
            ...
            for (var h = a[m], g = a[m + 1], v = h; g > v; v++) {
              var d = i[v];
              for (r = t ? f[p + d] : d; -1 != r && m > r; r = n)
                (n = f[l + r]), (f[l + r] = m), -1 == n && (c[r] = m);
              t && (f[p + d] = m);
            }
          }
          return c;
        ...
        var i = n(r(59)),
          ...
          o = function (e, t, r, n) {
            ...
            if (n) {
              ...
              for (o = 0; h > o; o++) {
                for (u = g, l = O[o], p = O[o + 1], f = l; p > f; f++)
                  u = Math.min(u, d[_[f]]);
                (d[E + o] = d[N + u]), (d[N + u] = o);
              }
            }
    ...
    function (e, t) {
      ...
      function r() {
        var e = function (e, t, r, n, i, a, o) {
          ...
          if (((r[i + e] = r[n + t]), (c = r[a + e]), (r[a + e] = t), -1 === c))
            (l = 1), (f = e);
          else {
        ...
        var i = n(r(63)),
          ...
          l = function (e, t, r) {
            ...
            var g,
              ...
              y = [],
              x = [],
              b = new f({ values: d, index: y, ptr: x, size: [p, p] }),
              w = [],
              N = [],
              E = [],
            ...
            for (var T = 0; p > T; T++) {
              ...
              var I = _[z];
              for (
                N[h] = T, w[h++] = I, A[z] = T, y[m] = z, d[m++] = 1, v = S;
                p > v;
                v++
              )
                (g = O[v]),
                  A[g] < 0 && ((y[m] = g), (d[m++] = a(_[g], I))),
                  (_[g] = 0);
            }
            for (x[p] = m, E[p] = h, v = 0; m > v; v++) y[v] = A[y[v]];
            return (
              d.splice(m, d.length - m),
              y.splice(m, y.length - m),
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        ...
        return (
          (m.toTex =
            "\\left(${args[0]}" + p.operators.largerEq + "${args[1]}\\right)"),
          m
        );
      }
      var i = r(8).nearlyEqual;
          ...
          h = function (e, t) {
            ...
            for (
              ...
              if (c(y, 0)) v[d] = [0];
                ...
                for (var w = o(y, x); b > n; n++)
                  (r = h[n]), (i[r] = [u(i[r][0] || 0, s(w, m[n]))]);
                v[d] = [w];
              }
            }
      ...
      function n(e) {
        var t = e.DenseMatrix,
          r = function (e, r, n) {
            ...
            if (2 !== i.length)
              throw new RangeError(
                "Matrix must be two dimensional (size: " + a.format(i) + ")"
              );
            var u = i[0],
              c = i[1];
            if (u !== c)
              throw new RangeError(
                "Matrix must be square (size: " + a.format(i) + ")"
              );
            var f, l, p;
            if (r && r.isMatrix === !0) {
              var m = r.size();
          ...
          h = function (e, t) {
            ...
            for (
              ...
              if (c(y, 0)) v[d] = [0];
                ...
                for (var N = o(y, x); n >= b; n--)
                  (r = h[n]), (i[r] = [u(i[r][0], s(N, m[n]))]);
                v[d] = [N];
              }
            }
            return new l({ data: v, size: [a, 1] });
    ...
    function (e, t, r) {
      "use strict";
      function n(e, t, n, a) {
        var o = a.find(n(r(41)), ["Complex,Complex"]),
          s = a("cube", {
            number: function (e) {
              return e * e * e;
            },
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        return (
          (g.toTex =
            "\\left(${args[0]}" + s.operators.dotDivide + "${args[1]}\\right)"),
          g
        );
      }
      ...
      function n(e, t, n, a) {
        var o = n(r(33)),
          ...
          u = function (e, t, r, n) {
            ...
            return (
              (M[y] = E.length),
              new s({ values: N, index: E, ptr: M, size: [d, y], datatype: v })
            );
          };
        return u;
      }
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        return (
          (h.toTex =
            "\\left(${args[0]}" + s.operators.dotPow + "${args[1]}\\right)"),
          h
        );
      }
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        function s(r, n) {
          return i(n) || r >= 0 || t.predictable
            ? Math.pow(r, n)
            : u(new e.Complex(r, 0), new e.Complex(n, 0));
        }
        function u(e, t) {
          return p(g(h(e), t));
        }
        function c(e, t) {
          ...
          for (var n = m(r[0]).valueOf(), o = e; t >= 1; )
            1 == (1 & t) && (n = g(o, n)), (t >>= 1), (o = g(o, o));
          return n;
        }
        function f(e, t) {
          ...
          d = o("pow", {
            ...
            "BigNumber, BigNumber": function (r, n) {
              return n.isInteger() || r >= 0 || t.predictable
                ? r.pow(n)
                : u(
                    new e.Complex(r.toNumber(), 0),
                    new e.Complex(n.toNumber(), 0)
                  );
            },
        ...
        return (
          (d.toTex =
            "\\left(${args[0]}\\right)" + l.operators.pow + "{${args[1]}}"),
          d
        );
      }
      var i = r(8).isInteger,
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        ...
        function s(t) {
          return new e.Complex(
            Math.log(Math.sqrt(t.re * t.re + t.im * t.im)),
            Math.atan2(t.im, t.re)
          );
        }
        var u = n(r(51)),
          c = a("log", {
    ...
    function (e, t) {
      ...
      e.exports = function (e, t, r, n, i, a, o, s, u, c, f) {
        var l,
          ...
          y = o._index;
        if (n)
          for (p = d[t], m = d[t + 1], l = p; m > l; l++)
            (h = v[l]),
              r[h] !== a
                ? ((r[h] = a),
                  y.push(h),
                  c
                    ? ((n[h] = u ? s(g[l], f) : s(f, g[l])), (i[h] = a))
                    : (n[h] = g[l]))
                : ((n[h] = u ? s(g[l], n[h]) : s(n[h], g[l])), (i[h] = a));
        else
          for (p = d[t], m = d[t + 1], l = p; m > l; l++)
            (h = v[l]), r[h] !== a ? ((r[h] = a), y.push(h)) : (i[h] = a);
      };
    },
    function (e, t, r) {
      "use strict";
      function n(e, t, r, n) {
        function a(t) {
          return new e.Complex(
            ...
            Math.atan2(t.im, t.re) / Math.LN10
          );
        }
        var o = n("log10", {
          number: function (r) {
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        return (
          (g.toTex =
            "\\left(${args[0]}" + s.operators.mod + "${args[1]}\\right)"),
          g
        );
      }
      ...
      function n(e, t, n, i) {
        ...
        var o = n(r(63)),
          ...
          y = i("norm", {
            ...
            "number | Complex | BigNumber | boolean | null, number | BigNumber | string":
              function (e) {
                return y(e);
              },
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        ...
        function o(t) {
          var r,
            n,
            i = Math.sqrt(t.re * t.re + t.im * t.im);
          return (
            (r =
              t.re >= 0
                ? 0.5 * Math.sqrt(2 * (i + t.re))
                : Math.abs(t.im) / Math.sqrt(2 * (i - t.re))),
            (n =
              t.re <= 0
                ? 0.5 * Math.sqrt(2 * (i - t.re))
                : Math.abs(t.im) / Math.sqrt(2 * (i + t.re))),
            t.im >= 0 ? new e.Complex(r, n) : new e.Complex(r, -n)
          );
        }
        var s = n("sqrt", {
          number: a,
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        ...
        return (
          (m.toTex =
            "\\left(${args[0]}" + p.operators.smaller + "${args[1]}\\right)"),
          m
        );
      }
      var i = r(8).nearlyEqual;
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        function s(t, r) {
          var n = new e.BigNumber(0),
            i = new e.BigNumber(1),
            a = r.isNegative();
          if ((a && (r = r.negated()), r.isZero()))
      ...
      function a(e, t) {
        ...
        for (
          var r = e.toPolar(), n = [], i = Math.pow(r.r, 1 / t), a = 0;
          t > a;
          a++
        )
          n.push({ r: i, phi: (r.phi + 2 * Math.PI * a) / t });
        return n;
      }
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        ...
        return (
          (s.toTex = o.operators.unaryPlus + "\\left(${args[0]}\\right)"), s
        );
      }
      var i = r(29);
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        ...
        var u = n(r(23)),
          c = a("xgcd", { "number, number": o, "BigNumber, BigNumber": s });
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        return (
          (h.toTex =
            "\\left(${args[0]}" + s.operators.bitAnd + "${args[1]}\\right)"),
          h
        );
      }
      var i = r(8).isInteger,
    ...
    function (e, t, r) {
      ...
      e.exports = function (e, t, r) {
        ...
        var h = l.length,
          ...
          x = new s(2),
          b = s.precision;
        for (s.config({ precision: 1e9 }); h > 0; )
          r(l[--h], p[--g]) == v && (d = d.plus(y)), (y = y.times(x));
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        return (
          (h.toTex =
            "\\left(${args[0]}" + s.operators.bitOr + "${args[1]}\\right)"),
          h
        );
      }
      var i = r(8).isInteger,
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        return (
          (h.toTex =
            "\\left(${args[0]}" + s.operators.bitXor + "${args[1]}\\right)"),
          h
        );
      }
      var i = r(8).isInteger,
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        return (
          (y.toTex =
            "\\left(${args[0]}" + s.operators.leftShift + "${args[1]}\\right)"),
          y
        );
      }
      var i = r(8).isInteger,
          ...
          u = function (e, t, r) {
            ...
            for (
              ...
              for (M = c[k], A = c[k + 1], E = M; A > E; E++)
                (_ = u[E]), (B[_] = I), (z[_] = n[E]), T.push(_);
              for (M = h[k], A = h[k + 1], E = M; A > E; E++)
                (_ = m[E]), B[_] === I && (z[_] = N(z[_], p[E]));
    ...
    function (e, t, r) {
      e.exports = [r(137), r(146), r(138), r(148)];
    },
    function (e, t, r) {
      "use strict";
      function n(e, t, n, i) {
      ...
      function n(e, t, n, o) {
        var s = n(r(142)),
          ...
          c = o("factorial", {
            ...
            BigNumber: function (t) {
              return t.isFinite() || t.isNegative()
                ? s(t.plus(1))
                : a.tau(e.BigNumber).sqrt();
            },
            "Array | Matrix": function (e) {
              return i(e, c);
            },
        ...
        return (
          (c.toTex = "\\left(${args[0]}\\right)" + u.operators.factorial), c
        );
      }
      var i = r(29),
        a = r(140);
    ...
    function (e, t, r) {
      ...
      (t.e = i(function (e) {
        ...
        (t.pi = i(function (e) {
          var t = e.constructor({ precision: e.precision + 4 }),
    ...
    function (e, t) {
      e.exports = function (e) {
        for (
          var t = e, r = NaN, n = e.times(e), i = e, a = !0, o = 3;
          !t.equals(r);
          o += 2
        )
          (i = i.times(n)),
            (r = t),
            (a = !a),
            (t = a ? t.plus(i.div(o)) : t.minus(i.div(o)));
        return t;
      };
    },
    function (e, t, r) {
      ...
      function n(e, t, n, f) {
        function l(r) {
          ...
          var s = t.precision + (0 | Math.log(o)),
            f = e.BigNumber.constructor({ precision: s });
          if (((o -= c.length), (a = u[s]))) {
          ...
          for (var p = a.length; o > p; ++p)
            (a[p] = i = i.times(n)), (n = n.plus(l));
          return (
            (a[o] = i.times(n)), new e.BigNumber(a[o].toPrecision(t.precision))
          );
        }
        var p = n(r(40)),
          m = n(r(100)),
          h = f("gamma", {
            number: function (e) {
              ...
              if (0.5 > e) return Math.PI / (Math.sin(Math.PI * e) * h(1 - e));
              ...
              return (
                (t = e + o + 0.5),
                Math.sqrt(2 * Math.PI) * Math.pow(t, e + 0.5) * Math.exp(-t) * r
              );
            },
            Complex: function (t) {
              var r, n;
              ...
              for (var i = 1; i < s.length; ++i) {
                var a = t.re + i,
                  u = a * a + t.im * t.im;
                0 != u
                  ? ((n.re += (s[i] * a) / u), (n.im += -(s[i] * t.im) / u))
                  : (n.re = s[i] < 0 ? -(1 / 0) : 1 / 0);
              }
              r = new e.Complex(t.re + o + 0.5, t.im);
              ...
              var l = Math.exp(-r.re);
              return (
                (r.re = l * Math.cos(-r.im)),
                (r.im = l * Math.sin(-r.im)),
                p(p(f, r), n)
              );
            },
            BigNumber: function (t) {
      ...
      var i = r(29),
        ...
        c = [
          ...
          355687428096e3, 6402373705728e3, 0x1b02b9306890000, 243290200817664e4,
        ];
      ...
      function n(e, t, r, n) {
        var o = n("combinations", {
          "number, number": function (e, t) {
            ...
            for (r = Math.max(t, e - t), n = 1, i = 1; e - r >= i; i++)
              n = (n * (r + i)) / i;
            return n;
          },
          "BigNumber, BigNumber": function (t, r) {
            ...
            for (
              n = t.minus(r), r.lt(n) && (n = r), a = u, o = u, s = t.minus(n);
              o.lte(s);
              o = o.plus(1)
            )
    ...
    function (e, t, r) {
      e.exports = [r(150), r(151), r(152), r(153)];
    },
    function (e, t, r) {
      "use strict";
      function n(e, t, r, n) {
    ...
    function (e, t, r) {
        ...
        var l = n(r(23)),
          p = f("intersect", {
            "Array, Array, Array": function (e, t, r) {
              if (!a(e))
                throw new TypeError(
                  "Array with 3 numbers expected for first argument"
                );
              if (!a(t))
                throw new TypeError(
                  "Array with 3 numbers expected for second argument"
                );
              if (!o(r))
                throw new TypeError(
            ...
            "Array, Array, Array, Array": function (e, t, r, n) {
              if (2 === e.length) {
                if (!i(e))
                  throw new TypeError(
                    "Array with 2 numbers expected for first argument"
                  );
                if (!i(t))
                  throw new TypeError(
                    "Array with 2 numbers expected for second argument"
                  );
                if (!i(r))
                  throw new TypeError(
                    "Array with 2 numbers expected for third argument"
                  );
                if (!i(n))
                  throw new TypeError(
                    "Array with 2 numbers expected for fourth argument"
                  );
              ...
              if (3 === e.length) {
                ...
                if (!a(r))
                  throw new TypeError(
                    "Array with 3 numbers expected for third argument"
                  );
                if (!a(n))
                  throw new TypeError(
                    "Array with 3 numbers expected for fourth argument"
                  );
                return u(
                  e[0],
                  e[1],
      ...
      function c(e, t, r, n, i, a, o, s, u, c) {
        var f =
            (c - e * o - t * s - r * u) / (n * o + i * s + a * u - e - t - r),
          l = e + f * (n - e),
          p = t + f * (i - t),
          m = r + f * (a - r);
        return [l, p, m];
    ...
    function (e, t, r) {
      e.exports = [r(157), r(158), r(159), r(160)];
    },
    function (e, t, r) {
      "use strict";
      function n(e, t, n, i) {
        ...
        return (
          (h.toTex =
            "\\left(${args[0]}" + a.operators.and + "${args[1]}\\right)"),
          h
        );
      }
      ...
      function n(e, t, n, i) {
        var a = r(26),
          ...
          p = i("or", {
            ...
            "Unit, Unit": function (e, t) {
              return (
                (0 !== e.value && null !== e.value) ||
                (0 !== t.value && null !== t.value)
              );
            },
            "Matrix, Matrix": function (e, t) {
              var r;
        ...
        return (
          (p.toTex =
            "\\left(${args[0]}" + a.operators.or + "${args[1]}\\right)"),
          p
        );
      }
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        return (
          (p.toTex =
            "\\left(${args[0]}" + a.operators.xor + "${args[1]}\\right)"),
          p
        );
      }
        ...
        var s = n(r(139)),
          u = o("permutations", {
            ...
            "BigNumber, BigNumber": function (t, r) {
              ...
              for (
                n = new e.BigNumber(1), a = t.minus(r).plus(1);
                a.lte(t);
                a = a.plus(1)
              )
                n = n.times(a);
            ...
            var t = {
                ...
                pickRandom: function (e) {
                  if (1 !== arguments.length)
                    throw new i("pickRandom", arguments.length, 1);
                  if (e && e.isMatrix === !0) e = e.valueOf();
                  else if (!Array.isArray(e))
                    throw new TypeError(
                      "Unsupported type of value in function pickRandom"
                    );
              ...
              o = function (e, t, r, n) {
                ...
                else for (a = 0, i = e.shift(); i > a; a++) s.push(n(t, r));
                return s;
              };
            return t;
          })(r);
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        return (
          (m.toTex =
            "\\left(${args[0]}" + p.operators.equal + "${args[1]}\\right)"),
          m
        );
      }
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        ...
        return (
          (m.toTex =
            "\\left(${args[0]}" + p.operators.smallerEq + "${args[1]}\\right)"),
          m
        );
      }
      var i = r(8).nearlyEqual;
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        ...
        return (
          (m.toTex =
            "\\left(${args[0]}" + p.operators.unequal + "${args[1]}\\right)"),
          m
        );
      }
      var i = r(8).nearlyEqual;
    ...
    function (e, t, r) {
      ...
      e.exports = function (e, t, r) {
        ...
        return e && e.isMatrix === !0
          ? e.create(n(e.valueOf(), t, r))
          : n(e, t, r);
      };
    },
    function (e, t, r) {
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        function o(e) {
          ...
          if (t % 2 == 0) {
            for (
              var r = t / 2 - 1, n = f(e, r + 1), a = e[r], o = 0;
              r > o;
              ++o
            )
              c(e[o], a) > 0 && (a = e[o]);
        ...
        var s = n(r(27)),
          ...
          m = a({
            "number | BigNumber | Unit, number | BigNumber | Unit": function (
              e,
              t
            ) {
              return u(s(e, t), 2);
        ...
        function u(e, t, r) {
          ...
          for (var n = 0, i = e.length - 1; i > n; ) {
            for (
              var a = n,
                o = i,
                s = e[Math.floor(Math.random() * (i - n + 1)) + n];
              o > a;
              ...
              if (Array.isArray(r)) {
                ...
                for (var p = 0; p < o.length; ++p) {
                  ...
                  if (a(h)) {
                    ...
                    if (((c = h.constructor.ONE), h.isNegative() || h.gt(c)))
                      throw new Error(
                        "Probability must be between 0 and 1, inclusive"
                      );
                  }
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        function s(t, r) {
          ...
          if (0 == t.length)
            throw new SyntaxError(
              "Function var requires one or more parameters (0 provided)"
            );
          if (
            (a(t, function (e) {
              (n = u(n, e)), i++;
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        var u = o.find(n(r(112)), ["Complex"]),
          c = o.find(n(r(102)), ["Complex"]),
          f = o("acos", {
            number: function (r) {
    ...
    function (e, t, r) {
      ...
      e.exports = function (e, t, r) {
        ...
        if ((!r && !e.isFinite()) || (r && e.isZero())) {
          var s = n
            .pi(t.constructor({ precision: o + 2 }))
            .div(2)
            .toDP(o - 1);
        ...
        if (u.lte(0.875)) {
          ...
          return (
            (c.constructor = t),
            t.config({ precision: o }),
            c.toDP(t.precision - 1)
          );
        }
        if (u.gte(1.143)) {
          var s = n.pi(t.constructor({ precision: o + 4 })).div(2),
    ...
    function (e, t, r) {
      ...
      e.exports = function o(e, t, r) {
        ...
        if (u.gt(0.8)) {
          ...
          var c = e.s,
            f = n(t.constructor({ precision: s + 4 })).div(2);
          return (
            (e = f.minus(o(t.ONE.minus(e.times(e)).sqrt(), t))),
            (e.s = c),
            (e.constructor = t),
            t.config({ precision: s }),
            e.toDP(s - 1)
        ...
        var l = u.gt(0.58);
        l &&
          (t.config({ precision: s + 8 }),
          (e = e.div(
            new t(2)
              .sqrt()
              .times(t.ONE.minus(e.times(e)).sqrt().plus(t.ONE).sqrt())
          )),
          t.config({ precision: s }));
        var p =
          60 >= s || (e.dp() <= Math.log(s) && e.lt(0.05)) ? i(e, s) : a(e, t);
      ...
      e.exports = function (e, t) {
        ...
        for (
          ...
          (s = s.times(o)),
            ...
            (a = i),
            (f = new r(l)),
            (i = i.plus(s.times(u).div(f.times(c))));
    ...
    function (e, t, r) {
      ...
      e.exports = function (e, t) {
        ...
        if (c == u)
          throw new Error(
            "asin() failed to converge to the requested accuracy.Try with a higher precision."
          );
    ...
    function (e, t, r) {
      ...
      e.exports = function (e, t, r, a) {
        ...
        if (
          (t.config({ precision: c }),
          (s = n(s, t.constructor({ precision: c }), r)),
          (s[0].constructor = t),
          s[1])
        )
          return (
            (s = s[0]),
            a && s.isZero() && (s = new t(1 / 0)),
            t.config({ precision: o }),
            s
          );
        var f;
        if (((s = s[0]), r)) {
          ...
          for (
            var l = new t(5), p = new t(16), m = new t(20), h = 0;
            5 > h;
            ++h
          ) {
            var g = f.times(f),
          ...
          var y, x;
          s.abs().lt(t.ONE) ? ((y = 64), (x = 3)) : ((y = 256), (x = 4)),
            (f = i(s.div(y), r)),
            t.config({ precision: Math.min(c, o + 8) });
        ...
        return (
          a && (f = f.e <= -o ? new t(1 / 0) : t.ONE.div(f)),
          t.config({ precision: o }),
          f.toDP(o - 1)
        );
      };
    ...
    function (e, t, r) {
      var n = r(140);
      e.exports = function (e, t, r) {
        var i = n.pi(t.constructor({ precision: t.precision + 2 })),
          a = n.tau(t);
        if (e.abs().lte(i.toDP(e.dp()))) return [e, !1];
        if (e.div(i.toDP(e.dp())).toNumber() % 2 == 0)
          return [new t(1 ^ r), !0];
        var o = e.mod(a);
        return o.toDP(e.dp(), 1).isZero()
          ? [new t(1 ^ r), !0]
          : (o.gt(i) &&
              (r ? ((o = o.minus(i)), (o.s = -o.s)) : (o = a.minus(o))),
    ...
    function (e, t) {
      e.exports = function (e, t) {
        for (
          ...
          (o = o.times(a)),
            (s = s.times(c + 1).times(c + 2)),
            (i = n),
            (u = !u),
            (n = u ? n.plus(o.div(s)) : n.minus(o.div(s)));
        return n;
      };
    },
    function (e, t) {
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        function s(e) {
          ...
          return (
            r.im <= 0
              ? ((t = r.re), (r.re = -r.im), (r.im = t))
              : ((t = r.im), (r.im = -r.re), (r.re = t)),
            r
          );
        }
        var u = o.find(n(r(192)), ["Complex"]),
          c = o("acosh", {
            number: function (r) {
              return r >= 1 || t.predictable
                ? Math.log(Math.sqrt(r * r - 1) + r)
                : -1 >= r
      ...
      function n(e, t, n, s) {
        var u = s.find(n(r(205)), ["Complex"]),
          c = s("acot", {
            ...
            Complex: function (t) {
              if (0 == t.im)
                return new e.Complex(t.re ? Math.atan(1 / t.re) : o, 0);
              var r = t.re * t.re + t.im * t.im;
              return (
                (t =
                  0 != r
                    ? new e.Complex((t.re = t.re / r), (t.im = -t.im / r))
                    : new e.Complex(
                        0 != t.re ? t.re / 0 : 0,
                        0 != t.im ? -(t.im / 0) : 0
                      )),
          ...
          u = o("atan", {
            ...
            Complex: function (t) {
              ...
              var r = t.re,
                ...
                o = s(a);
              return new e.Complex(-0.5 * o.im, 0.5 * o.re);
            },
            BigNumber: function (t) {
              return a(t, e.BigNumber, !1);
            },
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        function o(t) {
          ...
          var o = t.re;
          return (
            (t.re = Math.log(Math.sqrt(t.re * t.re + t.im * t.im)) / 2),
            (t.im = Math.atan2(t.im, o) / 2),
            r && (t.im = -t.im),
            t
          );
        }
            ...
            Complex: function (t) {
              if (0 == t.im)
                return (
                  (t =
                    0 != t.re
                      ? Math.log(t.re + Math.sqrt(t.re * t.re + 1))
                      : 1 / 0),
                  new e.Complex(t, 0)
                );
              var r = t.re * t.re + t.im * t.im;
    ...
    function (e, t, r) {
      ...
      e.exports = function (e, t, r) {
        ...
        if (t.isZero()) {
          ...
          var o = n
            .pi(r.constructor({ precision: a + 2 }))
            .div(2)
            .toDP(a - 1);
    ...
    function (e, t, r) {
      "use strict";
      function n(e, t, n, o) {
        var s = o.find(n(r(218)), ["number"]),
          u = o.find(n(r(220)), ["number"]),
          c = o("cos", {
            number: Math.cos,
            Complex: function (t) {
              return new e.Complex(
                Math.cos(t.re) * s(-t.im),
                Math.sin(t.re) * u(-t.im)
              );
            },
            BigNumber: function (t) {
              return a(t, e.BigNumber, 0, !1);
    ...
    function (e, t) {
      e.exports = function (e, t, r, n) {
        ...
        return (
          (a.constructor = t),
          (a = a.exp()),
          (a = r ? a.minus(t.ONE.div(a)) : a.plus(t.ONE.div(a))),
          (a = n ? new t(2).div(a) : a.div(2)),
          t.config({ precision: i }),
      ...
      function n(e, t, r, n) {
        var o = n("cot", {
          ...
          Complex: function (t) {
            var r =
              Math.exp(-4 * t.im) -
              2 * Math.exp(-2 * t.im) * Math.cos(2 * t.re) +
              1;
            return new e.Complex(
              (2 * Math.exp(-2 * t.im) * Math.sin(2 * t.re)) / r,
              (Math.exp(-4 * t.im) - 1) / r
            );
          },
          BigNumber: function (t) {
    ...
    function (e, t, r) {
      ...
      e.exports = function (e, t, r) {
        if (e.isNaN()) return new t(NaN);
        var s = t.precision,
          u = n.pi(t.constructor({ precision: s + 2 })),
          c = u.div(2).toDP(s - 1);
        u = u.toDP(s - 1);
        var f = o(e, t, 1)[0];
    ...
    function (e, t) {
      e.exports = function (e, t, r) {
        ...
        var a = i.exp(),
          ...
          s = a.minus(o);
        return (
          (s = r ? a.plus(o).div(s) : s.div(a.plus(o))),
          t.config({ precision: n }),
          s.toDP(n - 1)
        );
      };
    },
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        var o = n("csc", {
          ...
          Complex: function (t) {
            var r =
              0.25 * (Math.exp(-2 * t.im) + Math.exp(2 * t.im)) -
              0.5 * Math.cos(2 * t.re);
            return new e.Complex(
              (0.5 * Math.sin(t.re) * (Math.exp(-t.im) + Math.exp(t.im))) / r,
              (0.5 * Math.cos(t.re) * (Math.exp(-t.im) - Math.exp(t.im))) / r
            );
          },
          BigNumber: function (t) {
            return a(t, e.BigNumber, 1, !0);
    ...
    function (e, t, r) {
      ...
      function i(e) {
        return 0 == e
          ...
          : Math.abs(2 / (Math.exp(e) - Math.exp(-e))) * s(e);
      }
      var a = r(29),
        o = r(219),
        s = r(8).sign;
      ...
      function n(e, t, n, o) {
        var s = o.find(n(r(218)), ["number"]),
          ...
          c = o("sin", {
            ...
            Complex: function (t) {
              return new e.Complex(
                Math.sin(t.re) * s(-t.im),
                Math.cos(t.re) * u(t.im)
              );
            },
            BigNumber: function (t) {
              return a(t, e.BigNumber, 1, !1);
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        return (
          (c.toTex =
            "\\left(${args[0]}" + a.operators.to + "${args[1]}\\right)"),
          c
        );
      }
      ...
      function n(e, t, n, c) {
        function g(e, t) {
          ...
          if (e && e.isMatrix === !0)
            ...
            if (e)
              throw new TypeError(
                "Unsupported type of data (" + i.types.type(e) + ")"
              );
        ...
        function v(e, t) {
          ...
          for (
            var i = t.min(), o = t.max(), s = 0, u = e._size.length;
            u > s;
            s++
          )
            h(i[s], e._size[s]), h(o[s], e._size[s]);
        ...
        function y(e, t, r, n) {
          ...
          if (
            ...
            if (o.length < e._size.length)
              throw new a(o.length, e._size.length, "<");
        ...
        function b(e, t, r) {
          for (var n = u.clone(e._size), i = !1; n.length < t.length; )
            n.push(0), (i = !0);
        ...
        function w(e) {
          for (var t = 0, r = e.length; r > t; t++) {
            ...
            f(n)
              ? (e[t] = w(n))
              : n && n.isMatrix === !0 && (e[t] = w(n.valueOf()));
          }
          return e;
        }
        var N = n(r(246));
        (g.prototype = new N()),
          (g.prototype.type = "DenseMatrix"),
          (g.prototype.isDenseMatrix = !0),
        ...
        var E = function (e, t, r) {
          ...
          return (
            (e._size = u.clone(t)), (e._data = s.resize(e._data, e._size, r)), e
          );
        };
        return (
          ...
          (g.prototype.diagonal = function (e) {
            ...
            for (
              ...
              o[s] = u.clone(this._data[s + r][s + t]);
          ...
          (g.diagonal = function (t, r, n, i, a) {
            ...
            if (
              ((t = t.map(function (e) {
                if (
                  (e && e.isBigNumber === !0 && (e = e.toNumber()),
                  !l(e) || !p(e) || 1 > e)
                )
          ...
          (e.Matrix._storage.dense = g),
          (e.Matrix._storage["default"] = g),
          g
        );
      }
      var i = r(36),
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, g) {
        ...
        var d = n(r(246)),
          ...
          b = function (e, t, r) {
            ...
            var n = t.length,
              ...
              o = 0;
            if (
              (m(r) && ((a = g.find(y, [r, r]) || y), (o = g.convert(0, r))),
              n > 0)
            ) {
              var s = 0;
              do {
                ...
                for (var u = 0; n > u; u++) {
                  ...
                  if (f(c)) {
                    if (
                      (0 === s && i < c.length && (i = c.length), s < c.length)
                    ) {
                      var l = c[s];
                    ...
                    0 === s && 1 > i && (i = 1),
                      a(c, o) || (e._values.push(c), e._index.push(u));
                }
                s++;
              } while (i > s);
            }
        ...
        var w = function (e, t) {
            ...
            if (r) return e.get(t.min());
            var n = t.size();
            if (n.length != e._size.length)
              throw new a(n.length, e._size.length);
            var i,
              o,
              s,
              u,
              c = t.min(),
              f = t.max();
            for (i = 0, o = e._size.length; o > i; i++)
              h(c[i], e._size[i]), h(f[i], e._size[i]);
            var l = e._values,
              p = e._index,
              m = e._ptr,
              g = t.dimension(0),
            ...
            return (
              d.forEach(function (e) {
                for (N.push(w.length), s = m[e], u = m[e + 1]; u > s; s++)
          ...
          N = function (e, t, r, n) {
            ...
            if (
              ...
              if (1 !== u.length && 2 !== u.length)
                throw new a(u.length, e._size.length, "<");
              ...
              for (
                var p = t.min()[0], m = t.min()[1], h = i[0], g = i[1], v = 0;
                h > v;
                v++
              )
                for (var d = 0; g > d; d++) {
        ...
        (v.prototype.get = function (e) {
          ...
          return n < this._ptr[r + 1] && this._index[n] === t
            ? s.clone(this._values[n])
            : 0;
        }),
          (v.prototype.set = function (e, t, r) {
            ...
            var n = e[0],
              ...
              c = 0;
            m(this._datatype) &&
              ((u = g.find(y, [this._datatype, this._datatype]) || y),
              (c = g.convert(0, this._datatype))),
              (n > o - 1 || i > s - 1) &&
                (_(this, Math.max(n + 1, o), Math.max(i + 1, s), r),
                (o = this._size[0]),
                (s = this._size[1])),
              h(n, o),
              h(i, s);
        ...
        var _ = function (e, t, r, n) {
          var i = n || 0,
            ...
            o = 0;
          m(e._datatype) &&
            ((a = g.find(y, [e._datatype, e._datatype]) || y),
            (o = g.convert(0, e._datatype)),
            (i = g.convert(i, e._datatype)));
          var s,
            u,
            c,
            f = !a(i, o),
          ...
          if (((p = r), t > l)) {
            if (f) {
              ...
              for (u = 0; p > u; u++) {
                ...
                var v = 0;
                for (s = l; t > s; s++, v++)
                  e._values.splice(c + v, 0, i),
                    e._index.splice(c + v, 0, s),
                    h++;
              }
            ...
            for (u = 0; p > u; u++) {
              ...
              for (c = x; b > c; c++)
                (s = e._index[c]),
                  s > t - 1 &&
                    (e._values.splice(c, 1), e._index.splice(c, 1), d++);
            }
        ...
        var O = function (e, t, r, n, i, a, o) {
          var s = [],
            ...
            l = 0;
          m(e._datatype) &&
            ((f = g.find(y, [e._datatype, e._datatype]) || y),
            (l = g.convert(0, e._datatype)));
          for (
            ...
            c.push(s.length);
            for (
              var d = e._ptr[h], x = e._ptr[h + 1], b = t, w = d;
              x > w;
              w++
            ) {
              var N = e._index[w];
          ...
          return (
            c.push(s.length),
            new v({ values: s, index: u, ptr: c, size: [r - t + 1, i - n + 1] })
          );
        };
        (v.prototype.forEach = function (e, t) {
          ...
          for (
            var r = this, n = this._size[0], i = this._size[1], a = 0;
            i > a;
            a++
          ) {
            for (
              var o = this._ptr[a], s = this._ptr[a + 1], u = 0, c = o;
              s > c;
              c++
            ) {
              var f = this._index[c];
        ...
        var T = function (e, t, r, n, i) {
          ...
          for (o = 0; c > o; o++)
            for (var l = r[o], p = r[o + 1], m = l; p > m; m++)
              (a = t[m]), (f[a][o] = e ? (i ? s.clone(e[m]) : e[m]) : 1);
          return f;
        };
        return (
          (v.prototype.format = function (e) {
            for (
              ...
              for (
                var o = this._ptr[a], s = this._ptr[a + 1], c = o;
                s > c;
                c++
              ) {
                var f = this._index[c];
          ...
          (v.prototype.diagonal = function (e) {
            ...
            for (var f = t; i > f && o.length < a; f++)
              for (
                var m = this._ptr[f], h = this._ptr[f + 1], g = m;
                h > g;
                g++
              ) {
                var d = this._index[g];
            ...
            return (
              c.push(o.length),
              new v({ values: o, index: u, ptr: c, size: [a, 1] })
            );
          }),
          ...
          (v.diagonal = function (e, t, r, n, i) {
            ...
            return (
              E.push(w.length),
              new v({ values: w, index: N, ptr: E, size: [h, d] })
            );
          }),
      ...
      function n(e, t, n) {
        ...
        return (
          ...
          (i.prototype.accumulate = function (e, t) {
            ...
            r
              ? (r.value = a(r.value, t))
              : ((r = this._heap.insert(e, t)), (this._values[e] = r));
          }),
          (i.prototype.forEach = function (e, t, r) {
            ...
            for (s && a.push(s); s && s.key <= t; )
              s.key >= e && (o(s.value, 0) || r(s.key, s.value, this)),
                (s = n.extractMinimum()),
                s && a.push(s);
      ...
      function n(e) {
        function t(e) {
          ...
          for (var n = 0, i = arguments.length; i > n; n++) {
            ...
            if (a && a.isRange === !0)
              ...
              if ("number" != typeof a)
                throw new TypeError(
                  "Dimension must be an Array, Matrix, Number or Range"
                );
        ...
        return (
          ...
          (t.prototype.clone = function () {
            var e = new t();
            return (
              (e._dimensions = i(this._dimensions)),
          ...
          (t.prototype.toArray = function () {
            for (var e = [], t = 0, r = this._dimensions.length; r > t; t++)
              e.push(this._dimensions[t].toArray());
            return e;
          }),
          (t.prototype.valueOf = t.prototype.toArray),
          (t.prototype.toString = function () {
            for (var e = [], t = 0, r = this._dimensions.length; r > t; t++)
              e.push(this._dimensions[t].toString());
            return "[" + e.join(", ") + "]";
          }),
    ...
    function (e, t, r) {
      e.exports = [r(257), r(259)];
    },
    function (e, t, r) {
      function n(e, t, r, n, a) {
        var o = i.constructor(t);
        return (
          (o.prototype.type = "BigNumber"),
      ...
      !(function (i) {
        ...
        function o(e, t, r, n) {
          ...
          return (
            ...
            0 > o
              ? ((o += _), (i = 0))
              : ((i = Math.ceil((o + 1) / _)), (o %= _)),
            (a = E(10, _ - o)),
            (u = e[i] % a | 0),
            null == n
              ? 3 > o
                ? (0 == o ? (u = (u / 100) | 0) : 1 == o && (u = (u / 10) | 0),
                  (s =
                    (4 > r && 99999 == u) ||
                    (r > 3 && 49999 == u) ||
                    5e4 == u ||
                    0 == u))
                : (s =
                    (((4 > r && u + 1 == a) || (r > 3 && u + 1 == a / 2)) &&
                      ((e[i + 1] / a / 100) | 0) == E(10, o - 2) - 1) ||
                    ((u == a / 2 || 0 == u) && 0 == ((e[i + 1] / a / 100) | 0)))
              : 4 > o
              ? (0 == o
                  ? (u = (u / 1e3) | 0)
                  : 1 == o
                  ? (u = (u / 100) | 0)
                  : 2 == o && (u = (u / 10) | 0),
                (s = ((n || 4 > r) && 9999 == u) || (!n && r > 3 && 4999 == u)))
              : (s =
                  (((n || 4 > r) && u + 1 == a) ||
                    (!n && r > 3 && u + 1 == a / 2)) &&
                  ((e[i + 1] / a / 1e3) | 0) == E(10, o - 3) - 1),
            s
          );
        }
        function s(e, t, r) {
          ...
          return null == t ||
            (((y = 0 > t || t > 8) ||
              (0 !== t && (n.errors ? parseInt : parseFloat)(t) != t)) &&
              !p(n, "rounding mode", t, r, 0))
            ? n.rounding
            : 0 | t;
        }
        function u(e, t, r, n) {
          ...
          return (
            (!(y = (n || 0) > t || t >= S + 1) &&
              (0 === t || (i.errors ? parseInt : parseFloat)(t) == t)) ||
            p(i, "argument", t, r, 0)
          );
        }
        function c(e, t) {
          ...
          for (
            null == t ? ((b = !1), (u = y)) : (u = t), f = new h(0.03125);
            e.e > -2;

          )
            (e = e.times(f)), (m += 5);
          for (
            n = ((Math.log(E(2, m)) / Math.LN10) * 2 + 5) | 0,
              u += n,
              r = s = c = new h(v),
              h.precision = u;
            ;
            ...
            if (
              ...
              (r = r.times(++p)),
              (f = c.plus(k(s, r, u, 1))),
              a(f.c).slice(0, u) === a(c.c).slice(0, u))
            ) {
              for (i = m; i--; ) c = g(c.times(c), u, 1);
              if (null != t) return (h.precision = y), c;
              if (!(3 > l && o(c.c, u - n, d, l)))
                return g(c, (h.precision = y), d, (b = !0));
        ...
        function f(e, t, r, n) {
          var i,
            ...
            u = (e = new s(e)).e;
          if (
            (null == t ? (r = 0) : (g(e, ++t, r), (r = n ? t : t + e.e - u)),
            (u = e.e),
            (i = a(e.c)),
            1 == n || (2 == n && (u >= t || u <= s.toExpNeg)))
          ) {
            for (; i.length < r; i += "0");
            i.length > 1 && (i = i.charAt(0) + "." + i.slice(1)),
              (i += (0 > u ? "e" : "e+") + u);
          } else {
            if (((n = i.length), 0 > u)) {
              for (o = r - n; ++u; i = "0" + i);
        ...
        function h(e, t) {
          var r,
            ...
            A = E.rounding,
            _ = E.precision;
          if (w.s < 0 || !N || !N[0] || (!w.e && 1 == N[0] && 1 == N.length))
            return new E(N && !N[0] ? -1 / 0 : 1 != w.s ? NaN : N ? 0 : w);
          if (
            (null == t ? ((b = !1), (f = _)) : (f = t),
            (E.precision = f += x),
            (r = a(N)),
            (n = r.charAt(0)),
            !(Math.abs((s = w.e)) < 15e14))
          )
            return (
              (w = new E(n + "." + r.slice(1))),
              f + 2 > B.length && p(E, 1, f + 2, "ln"),
              (w = h(w, f - x).plus(new E(B.slice(0, f + 2)).times(s + ""))),
              (E.precision = _),
              null == t ? g(w, _, A, (b = !0)) : w
            );
          for (; (7 > n && 1 != n) || (1 == n && r.charAt(1) > 3); )
            (w = w.times(e)), (r = a(w.c)), (n = r.charAt(0)), y++;
          for (
            s = w.e,
              n > 1
                ? ((w = new E("0." + r)), s++)
                : (w = new E(n + "." + r.slice(1))),
              v = w,
              l = u = w = k(w.minus(M), w.plus(M), f, 1),
              d = g(w.times(w), f, 1),
              i = 3;
            ;
            ...
            if (
              ((u = g(u.times(d), f, 1)),
              (m = l.plus(k(u, new E(i), f, 1))),
              a(m.c).slice(0, f) === a(l.c).slice(0, f))
            ) {
              if (
                ((l = l.times(2)),
                0 !== s &&
                  (f + 2 > B.length && p(E, 1, f + 2, "ln"),
                  (l = l.plus(new E(B.slice(0, f + 2)).times(s + "")))),
                (l = k(l, new E(y), f, 1)),
                null != t)
              )
                return (E.precision = _), l;
              if (!o(l.c, f - x, A, c))
                return g(l, (E.precision = _), A, (b = !0));
              (E.precision = f += x),
                (m = u = w = k(v.minus(M), v.plus(M), f, 1)),
                (d = g(w.times(w), f, 1)),
                (i = c = 1);
            }
            (l = m), (i += 2);
          ...
          e: if (null != t) {
            ...
            if (
              (0 == a
                ...
                : ((f.length = l + 1),
                  (s = E(10, _ - a)),
                  (f[l] = o > 0 ? ((u / E(10, i - o)) % E(10, o) | 0) * s : 0)),
              n)
            )
              for (;;) {
                if (0 == l) {
        ...
        (T.absoluteValue = T.abs =
          ...
          (T.decimalPlaces = T.dp =
            function () {
              ...
              if ((e = this.c)) {
                if (
                  ((r = ((t = e.length - 1) - N(this.e / _)) * _), (t = e[t]))
                )
                  for (; t % 10 == 0; t /= 10, r--);
                0 > r && (r = 0);
              }
          ...
          (T.dividedToIntegerBy = T.divToInt =
            function (e, t) {
              var r = this,
                n = r.constructor;
              return (
                (w = 18), g(k(r, new n(e, t), 0, 1, 1), n.precision, n.rounding)
              );
            }),
          (T.equals = T.eq =
            function (e, t) {
          ...
          (T.logarithm = T.log =
            function (e, t) {
              ...
              if (
                ((n = v.c),
                v.s < 0 || !n || !n[0] || (!v.e && 1 == n[0] && 1 == n.length))
              )
                return new d(
                  n && !n[0] ? -1 / 0 : 1 != v.s ? NaN : n ? 0 : 1 / 0
                );
              if (
                ((u =
                  r &&
          ...
          (T.minus = function (e, t) {
            ...
            if (((c = c.slice()), (n = c.length), (u = p - l))) {
              for (
                (a = 0 > u)
                  ? ((u = -u), (r = c), (n = f.length))
                  : ((l = p), (r = f)),
                  (p = Math.ceil(m / _)) > n && (n = p),
                  u > (n += 2) && ((u = n), (r.length = 1)),
                  r.reverse(),
                  t = u;
                t--;
                r.push(0)
            ...
            if (
              (a && ((r = c), (c = f), (f = r), (e.s = -e.s)),
              (t = -((i = c.length) - f.length)) > 0)
            )
              for (; t--; c[i++] = 0);
            ...
            function (e, t) {
              ...
              return (
                ...
                r || !e.c || (i.c && !i.c[0])
                  ? r
                    ? new a(NaN)
                    : g(new a(i), a.precision, a.rounding)
                  : ((b = !1),
                    9 == o
                      ? ((e.s = 1),
                        (n = k(i, e, 0, 3, 1)),
          ...
          (T.plus = function (e, t) {
            ...
            if (!c || !u) {
              ...
              if (!o[0] || !s[0])
                return (
                  (n = s[0] ? e : new i(o[0] ? n : 0 * a)), b ? g(n, f, l) : n
                );
            }
            if (((o = o.slice()), (a = c - u))) {
              for (
            ...
            for (
              o.length - s.length < 0 && ((r = s), (s = o), (o = r)),
                a = s.length,
                t = 0,
                c = A;
              a;
            ...
            function (e) {
              ...
              return (
                e != t &&
                  ...
                  1 !== e &&
                  0 !== e &&
                  p(r.constructor, "argument", e, "precision", 1),
                r.c && ((t = l(r.c)), e && r.e + 1 > t && (t = r.e + 1)),
                t
              );
            }),
          (T.round = function () {
          ...
          (T.squareRoot = T.sqrt =
            function () {
              ...
              for (
                ...
                if (
                  ((o = n),
                  (n = p.times(o.plus(k(s, o, r + 2, 1)))),
                  a(o.c).slice(0, r) === (t = a(n.c)).slice(0, r))
                ) {
                  if (
                    ((t = t.slice(r - 3, r + 1)),
                    "9999" != t && (i || "4999" != t))
          ...
          (T.toDecimalPlaces = T.toDP =
            function (e, t) {
              var r = this;
              return (
                (r = new r.constructor(r)),
                null != e && u(r, e, "toDP")
                  ? g(r, (0 | e) + r.e + 1, s(r, t, "toDP"))
                  : r
              );
            }),
          (T.toExponential = function (e, t) {
            ...
            return r.c
              ? f(
                  r,
                  null != e && u(r, e, "toExponential") ? 0 | e : null,
                  null != e && s(r, t, "toExponential"),
                  1
                )
              : r.toString();
          }),
          (T.toFixed = function (e, t) {
            ...
            return (
              null != e &&
                ((e = u(n, e, (r = "toFixed")) ? n.e + (0 | e) : null),
                (t = s(n, t, r))),
              (i.toExpNeg = -(i.toExpPos = 1 / 0)),
              null != e && n.c
                ? ((r = f(n, e, t)),
                  n.s < 0 &&
                    n.c &&
          ...
          (T.toFormat = function (e, t) {
            ...
            if ((u && ((n = s), (s = u), (m -= u = n)), s > 0 && m > 0)) {
              for (n = m % s || s, f = p.substr(0, n); m > n; n += s)
                f += o + p.substr(n, s);
          ...
          (T.toFraction = function (e) {
            ...
            for (
              n = d.e = l(v) - f.e - 1,
                d.c[0] = E(10, (u = n % _) < 0 ? _ + u : u),
                (null == e ||
                  ((!((w = 12), (o = new m(e))).s ||
                    (y = o.cmp(h) < 0 || !o.c) ||
                    (m.errors && N(o.e / _) < o.c.length - 1)) &&
                    !p(m, "max denominator", e, "toFraction", 0)) ||
                  (e = o).cmp(d) > 0) &&
                  (e = n > 0 ? d : h),
                b = !1,
                o = new m(a(v)),
                u = m.precision,
                m.precision = n = v.length * _ * 2;
              (c = k(o, d, 0, 1, 1)), (r = t.plus(c.times(g))), 1 != r.cmp(e);

            )
              (t = g),
                (g = r),
                (h = s.plus(c.times((r = h)))),
                (s = r),
                (d = o.minus(c.times((r = d)))),
                (o = r);
            return (
              (r = k(e.minus(t), g, 0, 1, 1)),
              (s = s.plus(r.times(h))),
              (t = t.plus(r.times(g))),
              (s.s = h.s = f.s),
              (i =
                k(h, g, n, 1).minus(f).abs().cmp(k(s, t, n, 1).minus(f).abs()) <
                1
                  ? [h + "", g + ""]
                  : [s + "", t + ""]),
              (b = !0),
          ...
          (T.toNearest = function (e, t) {
            ...
            return (
              (r = new n(r)),
              null == e
                ? ((e = new n(n.ONE)), (t = n.rounding))
                : ((w = 17), (e = new n(e)), (t = s(r, t, "toNearest"))),
              e.c
                ? r.c &&
                  (e.c[0]
                    ? ((b = !1),
                      (r = k(r, e, 0, 4 > t ? [4, 5, 7, 8][t] : t, 1).times(e)),
                      (b = !0),
                      g(r))
                    : (r.c = [(r.e = 0)]))
                : r.s && (e.s && (e.s = r.s), (r = e)),
          ...
          (T.toPower = T.pow =
            function (e, t) {
              var r,
                ...
                d = f.precision,
                y = f.rounding;
              if (!u.c || !e.c || (i = !u.c[0]) || !e.c[0])
                return new f(E(i ? 0 * l : +u, p));
              if (
                ((u = new f(u)),
                (r = u.c.length),
                !u.e && u.c[0] == u.s && 1 == r)
                    ...
                    if (
                      ...
                      (n =
                        0 != t && isFinite(t)
                          ...
                          : N(
                              p *
                                (Math.log("0." + a(u.c)) / Math.LN10 + u.e + 1)
                            )),
                      n > f.maxE + 1 || n < f.minE - 1)
                    )
                      return new f(n > 0 ? l / 0 : 0);
                    (b = !1),
                      (f.rounding = u.s = 1),
                      (v = Math.min(12, (n + "").length)),
                      (s = c(e.times(h(u, d + v)), d)),
                      (s = g(s, d + 5, 1)),
                      o(s.c, d, y) &&
                        ((n = d + 10),
                        (s = g(c(e.times(h(u, n + v)), n), n + 5, 1)),
                        +a(s.c).slice(d + 1, d + 15) + 1 == 1e14 &&
                          (s = g(s, d + 1, 0))),
                      (s.s = l),
                      (b = !0),
                      (f.rounding = y);
          ...
          (T.toPrecision = function (e, t) {
            var r = this;
            return null != e && u(r, e, "toPrecision", 1) && r.c
              ? f(r, 0 | --e, s(r, t, "toPrecision"), 2)
              : r.toString();
          }),
          ...
          (T.toString = function (e) {
            ...
            if (null === s) r = i.s ? "Infinity" : "NaN";
              ...
              if (e === t && (s <= o.toExpNeg || s >= o.toExpPos))
                return f(i, null, o.rounding, 1);
              if (((r = a(i.c)), 0 > s)) {
                for (; ++s; r = "0" + r);
                r = "0." + r;
              } else if (((n = r.length), s > 0))
                if (++s > n) for (s -= n; s--; r += "0");
                else n > s && (r = r.slice(0, s) + "." + r.slice(s));
              else if (((t = r.charAt(0)), n > 1)) r = t + "." + r.slice(1);
              else if ("0" == t) return t;
              if (null != e)
                if ((y = !(e >= 2 && 65 > e)) || (e != (0 | e) && o.errors))
                  p(o, "base", e, "toString", 0);
          ...
          (v = (function () {
            function e(e, t, r) {
              for (var n, i, a = [0], o = 0, s = e.length; s > o; ) {
                ...
                for (a[(n = 0)] += O.indexOf(e.charAt(o++)); n < a.length; n++)
                  a[n] > r - 1 &&
                    (null == a[n + 1] && (a[n + 1] = 0),
                    (a[n + 1] += (a[n] / r) | 0),
                    (a[n] %= r));
            ...
            return function (t, r, n, i, a) {
              var o,
                ...
                g = t.rounding;
              for (
                37 > i && (r = r.toLowerCase()),
                  p >= 0 &&
                    ((r = r.replace(".", "")),
                    (l = new t(i)),
                    (c = m(t, l, r.length - p)),
                    (l.c = e(c.toFixed(), 10, n)),
                    (l.e = l.c.length)),
                  f = e(r, i, n),
                  o = s = f.length;
                0 == f[--s];
              ...
              if (
                ...
                for (f.length = h, --n; ++f[--h] > n; )
                  (f[h] = 0), h || (++o, f.unshift(1));
              else f.length = h;
              for (s = f.length; !f[--s]; );
              ...
              if (0 > o) {
                for (; ++o; r = "0" + r);
                r = "0." + r;
              } else if (((p = r.length), ++o > p)) for (o -= p; o--; r += "0");
                    ...
                    0 > c
                      ? ((E = b[0]),
                        ...
                        -1 == c &&
                          ((w = b.length),
                          (c = t(R, b, S, w)),
                          1 > c && (h++, r(b, w > S ? z : R, w, u))),
                        (w = b.length))
                      : 0 === c && (h++, (b = [0])),
                    (x[l++] = h),
                    c && b[0] ? (b[w++] = I[O] || 0) : ((b = [I[O]]), (w = 1));
                while ((O++ < T || null != b[0]) && k--);
                m = null != b[0];
              }
              x[0] || x.shift();
            }
        ...
        (d = (function () {
          function e(e) {
            ...
            return e == r ||
              ("object" != typeof e && !p(i, "object expected", e, a))
              ? i
              : ((n = e[(t = "precision")]) != r &&
                  ((y = 1 > n || n > S) || o(n) != n
                    ? p(i, t, n, a, 0)
                ...
                (e = e[(t = "format")]) != r &&
                  ("object" == typeof e
                    ? (i[t] = e)
                    : p(i, "format object expected", e, a)),
                i);
          }
          function t(e) {
          ...
          function i(e, t, r) {
            var n,
              ...
              a = 0;
            for (
              "[object Array]" == M.call(t[0]) && (t = t[0]), n = new e(t[0]);
              ++a < t.length;
          ...
          function c(e) {
            var t,
              ...
              s = new o(o.ONE);
            if (
              (null != e && u(s, e, "random") ? (e |= 0) : (e = o.precision),
              (r = Math.ceil(e / _)),
              o.crypto)
            )
              if (x && x.getRandomValues)
                for (t = x.getRandomValues(new Uint32Array(r)); r > i; )
                  (n = t[i]),
                    n >= 429e7
                      ? (t[i] = x.getRandomValues(new Uint32Array(1))[0])
                      : (a[i++] = n % 1e7);
              else if (x && x.randomBytes) {
                for (t = x.randomBytes((r *= 4)); r > i; )
                  (n =
                    t[i] +
                    (t[i + 1] << 8) +
                    (t[i + 2] << 16) +
          ...
          function l(i) {
            function u(e, t) {
              var r = this;
              if (!(r instanceof u))
                return p(u, "Decimal called without new", e), new u(e, t);
            ...
            return function (r, n, i, a) {
              ...
              if (
                ("string" != typeof i &&
                  (i =
                    (c =
                      "number" == typeof i || "[object Number]" == M.call(i)) &&
                    0 === i &&
                    0 > 1 / i
                      ? "-0"
                      : i + ""),
                ...
                n.s = 45 === i.charCodeAt(0) ? ((i = i.slice(1)), -1) : 1;
              else {
                ...
                if (
                  ...
                  (n.s =
                    45 === i.charCodeAt(0)
                      ...
                      : 1),
                  null != a
                    ? (a != (0 | a) && r.errors) || (y = !(a >= 2 && 65 > a))
                      ? (p(r, "base", a, 0, 0), (l = e.test(i)))
                      : ((o = "[" + O.slice(0, (a = 0 | a)) + "]+"),
                        ...
                        (l = new RegExp(
                          ...
                          ? (c &&
                              (i.replace(/^0\.0*|\./, "").length > 15 &&
                                p(r, 0, f),
                              (c = !c)),
                            (i = v(r, i, 10, a, n.s)))
                          : "Infinity" != i &&
                            "NaN" != i &&
                            (p(r, "not a base " + a + " number", f),
                            (i = "NaN")))
                    : (l = e.test(i)),
                  !l)
                )
                  return (
                    (n.c = n.e = null),
                    "Infinity" != i &&
                      ("NaN" != i && p(r, "not a number", f), (n.s = null)),
                    (w = 0),
                    n
                  );
              }
              for (
                (s = i.indexOf(".")) > -1 && (i = i.replace(".", "")),
                  (u = i.search(/e/i)) > 0
                    ? (0 > s && (s = u),
                      (s += +i.slice(u + 1)),
                      (i = i.substring(0, u)))
              ...
              if ((i = i.slice(u, a + 1))) {
                if (
                  ...
                  for (u && n.c.push(+i.slice(0, u)), a -= _; a > u; )
                    n.c.push(+i.slice(u, (u += _)));
      ...
      function n(e, t, n, o) {
        function s(e, t) {
          ...
          switch (arguments.length) {
            ...
            case 1:
              ...
              throw new SyntaxError(
                "Object with the re and im or r and phi properties expected."
              );
            case 2:
              if (!i(e) || !i(t))
                throw new TypeError(
            ...
            default:
              throw new SyntaxError(
                "One, two or three arguments expected in Complex constructor"
              );
          }
        }
        function u() {
        ...
        function g() {
          return new SyntaxError(
            'End of string expected, got "' + d.substr(y) + '"'
          );
        }
        var v = n(r(266));
        ...
        return (
          (s.parse = function (e) {
            if (((d = e), (y = -1), (x = ""), "string" != typeof d))
              throw new TypeError(
                "Invalid argument in Complex.parse, string expected"
              );
            l(), u();
            var t = m();
            if (t) {
              ...
              if (n) {
                if ("I" != x && "i" != x)
                  throw new SyntaxError(
                    'Character "i" expected, got "' + x + '"'
                  );
                l();
              } else if (((n = h()), !n))
                throw new SyntaxError("Imaginary part expected");
              if (
                ("-" == r && (n = "-" == n[0] ? "+" + n.substring(1) : "-" + n),
                l(),
                u(),
                x)
              )
            ...
            throw new SyntaxError(
              'Could not parse: "' + e + '" as complex number'
            );
          }),
              ...
              case 2:
                ...
                if (i(r)) {
                  if (
                    (n &&
                      n.isUnit &&
                      n.hasBase(v.BASE_UNITS.ANGLE) &&
                      (n = n.toNumber("rad")),
                    i(n))
                  )
                    return new s(r * Math.cos(n), r * Math.sin(n));
      ...
      function n(e, t, r, n) {
        function o(e, t) {
          ...
          if (void 0 != e && "number" != typeof e)
            throw new TypeError(
              "First parameter in Unit constructor must be a number"
            );
          ...
          if (void 0 != t) {
            ...
            (this.units = [{ unit: A, prefix: w, power: 0 }]),
        ...
        function m() {
          for (
            var e = "", t = v.charCodeAt(d);
            (t >= 48 && 57 >= t) ||
            (t >= 65 && 90 >= t) ||
            (t >= 97 && 122 >= t);

          )
            (e += y), f(), (t = v.charCodeAt(d));
          return (
            (t = e.charCodeAt(0)),
            (t >= 65 && 90 >= t) || (t >= 97 && 122 >= t) ? e || null : null
          );
        }
        function h(e) {
          return y === e ? (f(), e) : null;
        ...
        (o.parse = function (e) {
          ...
          for (var i = 1, a = !1, u = [], c = 1; ; ) {
            ...
            if (null == x)
              throw new SyntaxError(
                'Unexpected "' + l + '" in "' + v + '" at index ' + d.toString()
              );
            var b = g(x);
            ...
            for (var M = 0; M < N.length; M++)
              t.dimensions[M] += b.unit.dimensions[M] * w;
            for (s(); ")" === y; ) {
              if (0 === u.length)
                throw new SyntaxError(
                  'Unmatched ")" in "' + v + '" at index ' + d.toString()
                );
              (c /= u.pop()), f(), s();
            }
            (a = !1),
          ...
          if (0 !== u.length)
            throw new SyntaxError('Unmatched "(" in "' + v + '"');
          if (0 == t.units.length)
          ...
          (o.prototype.clone = function () {
            ...
            for (var r = 0; r < this.units.length; r++) {
              e.units[r] = {};
              for (var t in this.units[r])
                this.units[r].hasOwnProperty(t) &&
                  (e.units[r][t] = this.units[r][t]);
            }
            return e;
          }),
          ...
          (o.prototype._normalize = function (e) {
            ...
            if (this._isDerived()) {
              for (var t = e, r = 0; r < this.units.length; r++)
                t *= Math.pow(
                  this.units[r].unit.value * this.units[r].prefix.value,
                  this.units[r].power
                );
              return t;
            }
            return (
              (e + this.units[0].unit.offset) *
              this.units[0].unit.value *
              this.units[0].prefix.value
            );
          }),
          (o.prototype._denormalize = function (e, t) {
            if (0 === this.units.length) return e;
            if (this._isDerived()) {
              for (var r = e, n = 0; n < this.units.length; n++)
                r /= Math.pow(
                  this.units[n].unit.value * this.units[n].prefix.value,
                  this.units[n].power
                );
              return r;
            }
            return void 0 == t
              ? e / this.units[0].unit.value / this.units[0].prefix.value -
                  this.units[0].unit.offset
              : e / this.units[0].unit.value / t - this.units[0].unit.offset;
          }),
          ...
          (o.prototype.hasBase = function (e) {
            for (var t = 0; t < N.length; t++)
              if (Math.abs(this.dimensions[t] - e.dimensions[t]) > 1e-12)
                return !1;
            return !0;
          }),
          ...
          (o.prototype.multiply = function (e) {
            for (var t = this.clone(), r = 0; r < N.length; r++)
              t.dimensions[r] = this.dimensions[r] + e.dimensions[r];
          ...
          (o.prototype.pow = function (e) {
            for (var t = this.clone(), r = 0; r < N.length; r++)
              t.dimensions[r] = this.dimensions[r] * e;
            for (var r = 0; r < t.units.length; r++) t.units[r].power *= e;
            return (
              null != t.value
                ? (t.value = Math.pow(t.value, e))
                : (t.value = null),
          ...
          (o.prototype.to = function (e) {
            ...
            if ("string" == typeof e) {
              if (((t = o.parse(e)), !this.equalBase(t)))
          ...
          (o.prototype.simplifyUnitListLazy = function () {
            if (!this.isUnitListSimplified && null != this.value) {
              ...
              if ("NONE" === e) this.units = [];
                ...
                if (n)
                  this.units = [{ unit: n.unit, prefix: n.prefix, power: 1 }];
                else {
                  for (var i = 0; i < N.length; i++) {
                    var a = N[i];
                    Math.abs(this.dimensions[i]) > 1e-12 &&
                      t.push({
                        unit: C[a].unit,
                        prefix: C[a].prefix,
          ...
          (o.prototype.formatUnits = function () {
            ...
            for (
              ...
              this.units[i].power > 0
                ? (r++,
                  (e +=
                    " " + this.units[i].prefix.name + this.units[i].unit.name),
          ...
          (o.prototype.format = function (e) {
            if (
              ...
              this.units[0].prefix = t;
            }
            var r = this._denormalize(this.value),
              n = null !== this.value ? i(r, e) : "",
              a = this.formatUnits();
            return a.length > 0 && n.length > 0 && (n += " "), (n += a);
          }),
          (o.prototype._bestPrefix = function () {
            ...
            var e = Math.abs(this.value),
              t = this.units[0].prefix;
            if (0 === e) return t;
            var r = this.units[0].power,
              n = Math.abs(
                Math.log(e / Math.pow(t.value * this.units[0].unit.value, r)) /
                  Math.LN10 -
                  1.2
              ),
              i = this.units[0].unit.prefixes;
            for (var a in i)
              if (i.hasOwnProperty(a)) {
                ...
                if (o.scientific) {
                  var s = Math.abs(
                    Math.log(
                      e / Math.pow(o.value * this.units[0].unit.value, r)
                    ) /
                      Math.LN10 -
                      1.2
                  );
                  (n > s || (s === n && o.name.length < t.name.length)) &&
                    ((t = o), (n = s));
                }
              }
            return t;
        ...
        x.SHORTLONG = {};
        for (var b in x.SHORT)
          x.SHORT.hasOwnProperty(b) && (x.SHORTLONG[b] = x.SHORT[b]);
        for (var b in x.LONG)
          x.LONG.hasOwnProperty(b) && (x.SHORTLONG[b] = x.LONG[b]);
        var w = { name: "", value: 1, scientific: !0 },
          N = [
            "MASS",
            "LENGTH",
            "TIME",
        ...
        var M = {},
          ...
          _ = {
            ...
            ohm: {
              name: "ohm",
              base: E.ELECTRIC_RESISTANCE,
              prefixes: x.SHORTLONG,
              value: 1,
              offset: 0,
            },
            henry: {
              name: "henry",
              base: E.ELECTRIC_INDUCTANCE,
              prefixes: x.LONG,
              value: 1,
              offset: 0,
            },
        ...
        (T.cgs = JSON.parse(JSON.stringify(T.si))),
          (T.cgs.LENGTH = { unit: _.m, prefix: x.SHORT.c }),
          (T.cgs.MASS = { unit: _.g, prefix: x.SHORT[""] }),
          (T.cgs.FORCE = { unit: _.dyn, prefix: x.SHORT[""] }),
          (T.cgs.ENERGY = { unit: _.erg, prefix: x.NONE[""] }),
          (T.us = JSON.parse(JSON.stringify(T.si))),
          (T.us.LENGTH = { unit: _.ft, prefix: x.NONE[""] }),
          (T.us.MASS = { unit: _.lbm, prefix: x.NONE[""] }),
          (T.us.TEMPERATURE = { unit: _.degF, prefix: x.NONE[""] }),
          (T.us.FORCE = { unit: _.lbf, prefix: x.NONE[""] }),
          (T.us.ENERGY = { unit: _.BTU, prefix: x.BTU[""] }),
          (T.us.POWER = { unit: _.hp, prefix: x.NONE[""] }),
          (T.us.PRESSURE = { unit: _.psi, prefix: x.NONE[""] }),
          (T.auto = JSON.parse(JSON.stringify(T.si)));
        var C = T.auto;
        (o.setUnitSystem = function (e) {
          if (T.hasOwnProperty(e)) C = T[e];
          else {
            "Unit system " +
              e +
              " does not exist. Choices are: " +
              listAvailableUnitSystems();
          }
        }),
        ...
        var o = r(26),
          s = a("complex", {
            ...
            Object: function (t) {
              ...
              if ("r" in t && "phi" in t)
                return e.Complex.fromPolar(t.r, t.phi);
              throw new Error(
      ...
      (function (e) {
        ...
        !(function (a) {
          ...
          var c = { n: 0, d: 0, s: 0 },
                      ...
                      g.length === h + 1
                        ...
                        ? ("." !== g[h] && (u = o(g[h++], a)),
                          ...
                          (h + 1 === g.length ||
                            ...
                            ("'" === g[h + 1] && "'" === g[h + 3])) &&
                            ((f = o(g[h], a)),
                            (p = Math.pow(10, g[h].length)),
                            h++),
                          (("(" === g[h] && ")" === g[h + 2]) ||
                            ("'" === g[h] && "'" === g[h + 2])) &&
                            ((l = o(g[h + 1], a)),
                            (m = Math.pow(10, g[h + 1].length) - 1),
                            (h += 3)))
                        : "/" === g[h + 1] || ":" === g[h + 1]
                        ? ((f = o(g[h], a)), (p = o(g[h + 2], 1)), (h += 3))
                        : "/" === g[h + 3] &&
                          " " === g[h + 1] &&
                          ((u = o(g[h], a)),
                          (f = o(g[h + 2], a)),
            ...
            m = function (e, t, r) {
              for (var n = 0; 300 > n; n++)
                if (l(10, n, t) === l(10, n + r, t)) return n;
              return 0;
            },
            h = function (e, t) {
          ...
          (u.prototype.s = 1),
            ...
            (u.prototype.add = function (e, t) {
              return (
                f(e, t),
                new u(this.s * this.n * c.d + c.s * this.d * c.n, this.d * c.d)
              );
            }),
            ...
            (u.prototype.mod = function (e, t) {
              return void 0 === e
                ...
                : (f(e, t),
                  0 === c.n * this.d && u(0, 0),
                  new u(
                    (this.s * c.d * this.n) % (c.n * this.d),
                    c.d * this.d
                  ));
            }),
            (u.prototype.gcd = function (e, t) {
              return (
                f(e, t), new u(h(c.n, this.n), (c.d * this.d) / h(c.d, this.d))
              );
            }),
            ...
            (u.prototype.pow = function (e) {
              ...
              return (
                0 > e
                  ? ((this.d = Math.pow(r, -e)), (this.n = Math.pow(t, -e)))
                  : ((this.d = Math.pow(t, e)), (this.n = Math.pow(r, e))),
                0 === e % 2 && (this.s = 1),
                this
              );
            }),
            ...
            (u.prototype.divisible = function (e, t) {
              return (
                f(e, t), !(!(c.n * this.d) || (this.n * c.d) % (c.n * this.d))
              );
            }),
            ...
            (u.prototype.toString = function () {
              for (
                ...
                if (
                  (f < e.length ? (r += Number(e[f])) : ((u = 2), s++), a > 0)
                )
                  if (s === o) (n[u] += i + "("), (i = "");
                  else if (s === a + o) {
                    n[u] += i + ")";
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n) {
        var a = n("unit", {
          ...
          string: function (t) {
            return e.Unit.isValuelessUnit(t)
              ? new e.Unit(null, t)
              : e.Unit.parse(t);
          },
    ...
    function (e, t, r) {
      ...
      function n(e, t, o, s, u) {
        u.on("config", function (r, i) {
          ...
          (u["false"] = !1),
          (u["null"] = null),
          (u.uninitialized = r(18).UNINITIALIZED),
          "bignumber" === t.number
    ...
    function (e, t, r) {
      e.exports = [r(284), r(451), r(475), r(476), r(488), r(453), r(474)];
    },
    function (e, t, r) {
      function n(e, t, n, i) {
        var a = {};
        return (
          ...
          (a.bitXor = r(349)),
          (a.leftShift = r(350)),
          (a.rightArithShift = r(351)),
          (a.rightLogShift = r(352)),
          (a.bellNumbers = r(353)),
          (a.catalan = r(354)),
          (a.composition = r(355)),
          (a.stirlingS2 = r(356)),
          ...
          (a.transpose = r(382)),
          (a.zeros = r(383)),
          (a.combinations = r(384)),
          (a.factorial = r(385)),
          (a.gamma = r(386)),
          (a.kldivergence = r(387)),
          (a.multinomial = r(388)),
          (a.permutations = r(389)),
          (a.pickRandom = r(390)),
          (a.random = r(391)),
          (a.randomInt = r(392)),
          (a.compare = r(393)),
    ...
    function (e, t, r) {
      e.exports = [r(452), r(470), r(471), r(472), r(473)];
    },
    function (e, t, r) {
      "use strict";
      function n(e, t, n, a) {
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, o) {
        ...
        function p() {
          ...
          if ("\n" == de && !be)
            return (xe = le.DELIMITER), (ye = de), void c();
          var e = de + f(),
            t = e + l();
          if (3 == t.length && pe[t])
            return (xe = le.DELIMITER), (ye = t), c(), c(), void c();
          if (2 == e.length && pe[e])
            return (xe = le.DELIMITER), (ye = e), c(), void c();
        ...
        function x() {
          ...
          var e = b();
          if ("" != ye)
            throw xe == le.DELIMITER
              ? X("Unexpected operator " + ye)
              : J('Unexpected part "' + ye + '"');
          return e;
        }
        function b() {
          var e,
          ...
          for ("\n" != ye && ";" != ye && (e = w()); "\n" == ye || ";" == ye; )
            0 == r.length &&
              e &&
              ((t = ";" != ye), r.push({ node: e, visible: t })),
              p(),
              "\n" != ye &&
                ";" != ye &&
                "" != ye &&
                ((e = w()), (t = ";" != ye), r.push({ node: e, visible: t }));
          return r.length > 0 ? new ee(r) : e;
        }
        function w() {
          if (xe == le.SYMBOL && "function" == ye)
            throw J(
              'Deprecated keyword "function". Functions can now be assigned without it, like "f(x) = x^2".'
            );
          return N();
        }
        function N() {
          ...
          if ("=" == ye) {
            if (i && i.isSymbolNode)
              return (e = i.name), m(), (r = N()), new K(e, r);
        ...
        function E() {
          for (var e = M(); "?" == ye; ) {
            ...
            var r = e,
              n = M();
            if (":" != ye)
              throw J("False part of conditional expression expected");
            (we = null), m();
            var i = E();
            (e = new te(r, n, i)), (we = t);
          }
        ...
        function M() {
          for (var e = A(); "or" == ye; )
            m(), (e = new ae("or", "or", [e, A()]));
          return e;
        }
        function A() {
          for (var e = _(); "xor" == ye; )
            m(), (e = new ae("xor", "xor", [e, _()]));
          return e;
        }
        function _() {
          for (var e = O(); "and" == ye; )
            m(), (e = new ae("and", "and", [e, O()]));
          return e;
        }
        function O() {
          for (var e = T(); "|" == ye; )
            m(), (e = new ae("|", "bitOr", [e, T()]));
          return e;
        }
        function T() {
          for (var e = C(); "^|" == ye; )
            m(), (e = new ae("^|", "bitXor", [e, C()]));
          return e;
        }
        function C() {
          for (var e = S(); "&" == ye; )
            m(), (e = new ae("&", "bitAnd", [e, S()]));
          return e;
        }
        function S() {
          var e, t, r, n, i;
          for (
            ...
            (r = ye), (n = t[r]), m(), (i = [e, z()]), (e = new ae(r, n, i));
          return e;
        }
        function z() {
          var e, t, r, n, i;
        ...
        function I() {
          var e, t, r, n, i;
          for (e = R(), t = { "+": "add", "-": "subtract" }; ye in t; )
            (r = ye), (n = t[r]), m(), (i = [e, R()]), (e = new ae(r, n, i));
          return e;
        }
        function R() {
          var e, t, r, n, i;
          if (
            ...
            for (; ye in t; )
              (r = ye), (n = t[r]), m(), (i = [e, U()]), (e = new ae(r, n, i));
          return (
            (xe == le.SYMBOL ||
              ("in" == ye && e && e.isConstantNode) ||
              (xe == le.NUMBER && (!e || !e.isConstantNode)) ||
              "(" == ye ||
              "[" == ye) &&
              (e = new ae("*", "multiply", [e, R()])),
            e
          );
        }
        function U() {
          ...
          return r ? ((e = ye), m(), (t = [U()]), new ae(e, r, t)) : q();
        }
        function q() {
          var e, t, r, n;
          return (
        ...
        function P() {
          var e, t, r, n, i;
          for (e = L(), t = { "!": "factorial", "'": "transpose" }; ye in t; )
            (r = ye), (n = t[r]), p(), (i = [e]), (e = new ae(r, n, i));
          return e;
        }
        function L() {
          var e,
        ...
        function F() {
          var e, t;
          return xe == le.SYMBOL || (xe == le.DELIMITER && ye in me)
            ? ((t = ye), p(), (e = $(t)), (e = D(e)))
            : j();
        }
        function $(e) {
        ...
        var Q = n(r(454)),
          ...
          ce = n(r(465)),
          fe = n(r(469)),
          le = { NULL: 0, DELIMITER: 1, NUMBER: 2, SYMBOL: 3, UNKNOWN: 4 },
          pe = {
            ",": !0,
            "(": !0,
            ")": !0,
      ...
      function n(e, t, n, a) {
        ...
        return (
          ...
          (o.prototype._compile = function (e) {
            var t = "array" !== e.math.config().matrix,
              r = this.nodes.map(function (t) {
                return t._compile(e);
              });
          ...
          (o.prototype.map = function (e) {
            for (var t = [], r = 0; r < this.nodes.length; r++)
              t[r] = this._ifNode(e(this.nodes[r], "nodes[" + r + "]", this));
            return new o(t);
          }),
          (o.prototype.clone = function () {
    ...
    function (e, t, r) {
      ...
      function n(e, t, r, n, a) {
        ...
        return (
          ...
          (o.prototype.type = "Node"),
          (o.prototype.isNode = !0),
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        function o(e, t) {
          ...
          if (e in c)
            throw new Error(
              'Illegal symbol name, "' + e + '" is a reserved keyword'
            );
        ...
        return (
          ...
          (o.prototype._toTex = function (e) {
            var t = e && e.parenthesis ? e.parenthesis : "keep",
              r = this.expr.toTex(e);
            return (
              s(this, t) && (r = "\\left(" + r + "\\right)"),
              i.toSymbol(this.name) + ":=" + r
            );
          }),
          o
        );
    ...
    function (e, t) {
      ...
      function i(e, t, n) {
        ...
        var f = a[c][s];
        if (
          f.hasOwnProperty("associativeWith") &&
          f.associativeWith instanceof Array
        ) {
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        return (
          ...
          (a.prototype._compile = function (e) {
            e.ResultSet = s;
          ...
          (o.prototype._compile = function (e) {
            return (
              (e.testCondition = function (t) {
                ...
                throw new TypeError(
                  'Unsupported type of condition "' + e.math["typeof"](t) + '"'
                );
              }),
              "testCondition(" +
                this.condition._compile(e) +
                ") ? ( " +
                this.trueExpr._compile(e) +
                ") : ( " +
                this.falseExpr._compile(e) +
                ")"
            );
          }),
          (o.prototype.forEach = function (e) {
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a) {
        function o(e, t) {
          ...
          if (!u[this.valueType])
            throw new TypeError(
              'Unsupported type of value "' + this.valueType + '"'
            );
        }
        var s = n(r(455)),
        ...
        return (
          ...
          (o.prototype._compile = function (e) {
            switch (this.valueType) {
              ...
              default:
                throw new TypeError(
                  'Unsupported type of constant "' + this.valueType + '"'
                );
            }
          }),
          (o.prototype.forEach = function (e) {}),
    ...
    function (e, t, r) {
      ...
      function i(e, t, i, u) {
        function c(e, t, r) {
          ...
          if ("string" != typeof e)
            throw new TypeError('String expected for parameter "name"');
          if (!Array.isArray(t) || !t.every(n))
            throw new TypeError(
              'Array containing strings expected for parameter "params"'
            );
          if (!r || !r.isNode)
            throw new TypeError('Node expected for parameter "expr"');
          if (e in a)
        ...
        return (
          (c.prototype = new l()),
          (c.prototype.type = "FunctionAssignmentNode"),
          (c.prototype.isFunctionAssignmentNode = !0),
          (c.prototype._compile = function (e) {
            return (
              ...
              'scope["' +
                ...
                ") {      if (arguments.length != " +
                this.params.length +
                ') {        throw new SyntaxError("Wrong number of arguments in function ' +
                this.name +
                ' (" + arguments.length + " provided, ' +
                this.params.length +
                ' expected)");      }      return ' +
                this.expr._compile(e) +
                '    };    fn.syntax = "' +
                this.name +
                "(" +
                this.params.join(", ") +
      ...
      function n(e, t, n, i) {
        function a(e, t) {
          ...
          if (
            ...
            throw new TypeError(
              'Array containing Nodes expected for parameter "ranges"'
            );
        ...
        return (
          ...
          (a.prototype.compileSubset = function (e, t) {
            ...
            return n
              ? "(function () {  var obj = " +
                  this.object._compile(e) +
                  ";  var size = math.size(obj).valueOf();  return math.subset(    obj,     math.index(" +
                  a.join(", ") +
                  ")    " +
                  (t ? ", " + t : "") +
                  "  );})()"
          ...
          (a.prototype.map = function (e) {
            for (
              ...
              r[n] = this._ifNode(e(this.ranges[n], "ranges[" + n + "]", this));
            return new a(t, r);
          }),
      ...
      function n(e, t, n, a) {
        ...
        return (
          ...
          (o.prototype._compile = function (e) {
            return (
              "math.range(" +
              this.start._compile(e) +
              ", " +
              this.end._compile(e) +
              (this.step ? ", " + this.step._compile(e) : "") +
              ")"
            );
          }),
          (o.prototype.forEach = function (e) {
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, a, o) {
        ...
        return (
          ...
          (s.prototype._compile = function (e) {
            return (
              (e.undef = u),
              (e.Unit = f),
              this.name in e.args
          ...
          switch (r.length) {
            ...
            case 1:
              ...
              if (n && null !== u) {
                ...
                if (
                  ...
                  a.properties[i][f].latexLeftParens === !1)
                )
                  return [!1];
            ...
            case 2:
              ...
              if (
                ...
                "keep" === t
                  ? ((f = e.getIdentifier()),
                    (d = e.args[0].getIdentifier()),
                    (y = e.args[1].getIdentifier()))
                  : ((f = e.getContent().getIdentifier()),
                    (d = e.args[0].getContent().getIdentifier()),
                    (y = e.args[1].getContent().getIdentifier())),
                  null !== p &&
                    (a.properties[i][f].latexLeftParens === !1 && (l = !1),
                    a.properties[p][d].latexParens === !1 && (l = !1)),
                  null !== g &&
                    (a.properties[i][f].latexRightParens === !1 && (h = !1),
                    a.properties[g][y].latexParens === !1 && (h = !1));
              }
              return [l, h];
          }
        }
        var f = n(r(455));
        n(r(461)), n(r(465)), n(r(467));
        return (
          (u.prototype = new f()),
          (u.prototype.type = "OperatorNode"),
          (u.prototype.isOperatorNode = !0),
          (u.prototype._compile = function (e) {
      ...
      function n(e, t, n, a, o) {
        ...
        function u(e, t, r) {
          for (
            ...
            if (((i += e.substring(o, n.index)), (o = n.index), "$$" === n[0]))
              (i += "$"), o++;
            else {
              o += n[0].length;
              var s = t[n[1]];
              if (!s)
                throw new ReferenceError(
                  "Template: Property " + n[1] + " does not exist."
                );
              if (void 0 === n[2])
                switch (typeof s) {
                  case "string":
                ...
                if (!s[n[2]] || !s[n[2]].isNode)
                  throw new TypeError(
                    "Template: " + n[1] + "[" + n[2] + "] is not a Node."
                  );
                i += s[n[2]].toTex(r);
              }
            }
        ...
        (s.prototype = new c()),
          ...
          (s.prototype._compile = function (e) {
            var t = e.math[this.name],
              r = "function" == typeof t && 1 == t.rawArgs,
              n = this.args.map(function (t) {
                return t._compile(e);
              });
            if (r) {
              var i,
        ...
        return (
          ...
          (s.prototype._toTex = function (e) {
            var t,
              r =
                (e && e.parenthesis ? e.parenthesis : "keep",
                this.args.map(function (t) {
                  return t.toTex(e);
                }));
            !o[this.name] ||
              ("function" != typeof o[this.name].toTex &&
                "object" != typeof o[this.name].toTex &&
                "string" != typeof o[this.name].toTex) ||
              (t = o[this.name].toTex);
            var n;
            switch (typeof t) {
              case "function":
    ...
    function (e, t, r) {
      ...
      function n(e, t, n, i) {
        ...
        return (
          (a.prototype = new o()),
          (a.prototype.type = "UpdateNode"),
          (a.prototype.isUpdateNode = !0),
          (a.prototype._compile = function (e) {
            var t =
                this.index.objectName() in e.args
                  ? this.name + " = "
                  : 'scope["' + this.index.objectName() + '"]',
              r = this.index.compileSubset(e, this.expr._compile(e));
            return t + " = " + r;
          }),
          (a.prototype.forEach = function (e) {
          ...
          (a.prototype.map = function (e) {
            return new a(
              ...
              this._ifNode(e(this.expr, "expr", this))
            );
          }),
          (a.prototype.clone = function () {
          ...
          (a.prototype._toString = function (e) {
            ...
            return (
              e && "all" === e.parenthesis && (t = "(" + t + ")"),
              this.index.toString(e) + " = " + t
            );
          }),
          (a.prototype._toTex = function (e) {
            var t = this.expr.toTex(e);
            return (
              e && "all" === e.parenthesis && (t = "\\left(" + t + "\\right)"),
              this.index.toTex(e) + ":=" + t
            );
          }),
          a
        );
    ...
    function (e, t, r) {
      ...
      t.transform = function (e) {
        return e && e.isIndexError
          ? new n(e.index + 1, e.min + 1, e.max + 1)
          : e;
      };
    },
    function (e, t, r) {
            ...
            if (e[1] && e[1].isSymbolNode) i = e[1].compile().eval(r);
              ...
              var a = r || {},
                s = e[1].filter(function (e) {
                  return (
                    e && e.isSymbolNode && !(e.name in t) && !(e.name in a)
                  );
                })[0],
                u = Object.create(a),
                c = e[1].compile();
              if (!s)
                throw new Error(
                  "No undefined variable found in filter equation"
                );
              var f = s.name;
              i = function (e) {
        ...
        return function () {
          for (var t = [], r = 0, n = arguments.length; n > r; r++) {
            ...
            if (i && i.isRange === !0) i.start--, (i.end -= i.step > 0 ? 0 : 2);
              ...
              if (!i || i.isBigNumber !== !0)
                throw new TypeError(
                  "Ranges must be a Number, Range, Array or Matrix"
                );
              i = i.toNumber() - 1;
            }
            t[r] = i;
          ...
          (s.prototype.toString = function () {
            ...
            if (
              ...
              for (var r = 0; r < e.examples.length; r++) {
                ...
                i &&
                  !i.isHelp &&
                  (t += "        " + a.format(i, { precision: 14 }) + "\n");
              }
              t += "\n";
            }
            return (
              e.seealso && (t += "See also: " + e.seealso.join(", ") + "\n"), t
            );
          }),
          (s.prototype.toJSON = function () {
