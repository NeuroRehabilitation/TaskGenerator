...
var target = ["ARM","BACK","EARS","EYES","FACE","FEET","FINGERS","FOOT","HAIR","HANDS","HEAD","KNEES","LEGS","MOUTH","NECK","NOSE",
	"SHOULDERS","SKIN","STOMACH","TEETH","THUMBS","TOES","TONGUE","TOOTH","DRILL","HAMMER","KNIFE","PLANE","PLIERS","SAW","SCISSORS",
	"SCREWDRIVER","VISE","APPLE","BANANA","CHERRY","GRAPEFRUIT","GRAPES","LEMON","LIME","MELON","ORANGE","PEACH","PEAR",
	"PERSIMMON","PINEAPPLE","PLUM","STRAWBERRY","TANGERINE","WATERMELON","ALLIGATOR","ANT","BEAR","BEE","BIRD","CAMEL","CAT",
	"CHEETAH","CHICKEN","CHIMPANZEE","COW","CROCODILE","DEER","DOG","DOLPHIN","DUCK","EAGLE","ELEPHANT","FISH","FLY","FOX",
	"FROG","GIRAFFE","GOAT","GOLDFISH","HAMSTER","HIPPOPOTAMUS","HORSE","KANGAROO","KITTEN","LION","LOBSTER","MONKEY",
	"OCTOPUS","OWL","PANDA","PIG","PUPPY","RABBIT","RAT","SCORPION","SEAL","SHARK","SHEEP","SNAIL","SNAKE","SPIDER","SQUIRREL",
	"TIGER","TURTLE","WOLF","ZEBRA","BAKE","BOIL","BROIL","FRY","GRILL","MICROWAVE","BOWL","TOWELS","POACH","ROAST","SPOON",
	"SPATULA","STEAM","STRAINER","TIMER","FORK","AIRPLANE","BICYCLE","BOAT","BUS","CAR","HELICOPTER","HORSE","JET","MOTORCYCLE",
	"SHIP","SUBWAY","TAXI","TRAIN","TRUCK"];
...
var instructions;
if (cues=='0')
	instructions = "Por favor encuentre las "+ n_words +" palabras en el siguiente recuadro.";
else
{
	instructions = "Por favor encuentre las siguientes palabras (";
	...
	instructions += ") en el siguiente recuadro.";
}
doc.setFontSize(15);
text = doc.splitTextToSize("Instrucciones:\n\n\t" + instructions, 175);
doc.text(20, 45, text);
