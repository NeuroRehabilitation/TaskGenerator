...
if (numbers == 2)
{
	var instructions = "Por favor procure e assinale com um círculo os elementos '      '."
	doc.addImage(targetImg, 'JPEG', 172, 52, 6, 6);
}
else
	var instructions = "Por favor procure e assinale com um círculo os elementos ' " + target + " '."
