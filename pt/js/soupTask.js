...
var target = ["BRAÇO", "COSTAS", "ORELHAS", "OLHOS", "CARA", "PES", "DEDOS", "PE", "CABELO", "MAOS", "CABEÇA", "JOELHOS", "PERNAS", "BOCA", "PESCOÇO", "NARIZ",
	"OMBROS", "PELE", "ESTOMAGO", "DENTES", "POLEGARES", "DEDOS", "LINGUA", "DENTE", "PERFURAR", "MARTELO", "FACA", "AVIAO", "ALICATE", "TESOURA",
	"PARAFUSO", "TORNO", "MAÇA", "BANANA", "CEREJA", "GRAPEFRUIT", "UVA", "LIMAO", "LIMA", "MELAO", "LARANJA", "PESSEGO", "PERA",
	"CAQUI", "ABACAXI", "AMEIXA", "MORANGO", "TANGERINA", "MELANCIA", "JACARE", "FORMIGA", "URSO", "ABELHA", "PASSAROS", "CAMELO", "GATO",
	"CHITA", "GALINHA", "CHIMPANZE", "VACA", "CROCODILO", "VEADO", "CAO", "GOLFINHO", "PATO", "AGUIA", "ELEFANTE", "PEIXE", "VOAR", "RAPOSA",
	"SAPO", "GIRAFA", "CABRA", "PEIXINHO", "HAMSTER", "HIPOPOTAMO", "CAVALO", "CANGURU", "GATINHA", "LEAO", "LAGOSTA", "MACACO",
	"POLVO", "CORUJA", "PANDA", "PORCO", "CACHORRINHO", "COELHO", "RATO", "ESCORPIAO", "SELO", "TUBARAO", "OVELHAS", "CARACOL", "SERPENTE", "ARANHA", "ESQUILO",
	"TIGRE", "TARTARUGA", "LOBO", "ZEBRA", "ASSAR", "FERVER", "ASSAR", "FRITAR", "GRILL", "MICROONDAS", "TIGELA", "TOALHAS", "ROUBAR", "ASSADO", "COLHER",
	"ESPATULA", "VAPOR", "FILTRO", "RELOGIO", "GARFO", "AVIAO", "BICICLETA", "BARCO", "AUTOCARRO", "CARRO", "HELICOPTERO", "CAVALO", "JET", "MOTO",
	"NAVIO", "METRO", "TAXI", "COMBOIO", "CAMIAO"];
...
var instructions;
if (cues=='0')
	instructions = "Por favor, procure "+ n_words +" palavras nesta sopa de letras.";
else
{
