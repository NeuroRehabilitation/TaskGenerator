...
function categorizationTask(categories,elements,newpage)
{
    ...
    var instructions = "Raggruppi le seguenti immagini per categoria.";
    doc.setFontSize(15);
	...
	doc.setFontSize(8);
    doc.text(20, 275, "* Le immagini provengono dal database denominazione di immagini IPNP (http://crl.ucsd.edu/experiments/ipnp/method/getpics/getpics.html)");
